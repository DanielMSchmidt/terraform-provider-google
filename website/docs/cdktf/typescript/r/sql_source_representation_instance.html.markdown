...
values will be stored in the raw state as plain text: `onPremisesConfigurationPassword`.
...
* `databaseVersion` -
  ...
  Possible values are: `mysql56`, `mysql57`, `mysql80`, `postgres96`, `postgres10`, `postgres11`, `postgres12`, `postgres13`, `postgres14`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-b07df9a63857785dc40182df8e1306999de07b3ac767a33487421edf8797d8d1 -->