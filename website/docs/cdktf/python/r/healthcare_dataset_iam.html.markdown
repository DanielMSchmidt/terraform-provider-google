...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.healthcare_dataset_iam_policy.HealthcareDatasetIamPolicy(self, "dataset",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.healthcare_dataset_iam_binding.HealthcareDatasetIamBinding(self, "dataset",
            dataset_id="your-dataset-id",
            members=["user:jane@example.com"],
            role="roles/editor"
        )
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.healthcare_dataset_iam_member.HealthcareDatasetIamMember(self, "dataset",
            dataset_id="your-dataset-id",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-18e65a01618df0bb06bcb07fd64c710e25ac50c3d1490a889edf824b3d8cfcba -->