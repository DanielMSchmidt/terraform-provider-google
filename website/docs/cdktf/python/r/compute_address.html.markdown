...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_address.ComputeAddress(self, "ip_address",
            name="my-address"
        )
```
<div class = "oics-button" style="float: right; margin: 0 0 -15px">
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_address.ComputeAddress(self, "internal_with_subnet_and_address",
            address="10.0.42.42",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_compute_address_static = google.compute_address.ComputeAddress(self, "static",
            name="ipv4-address"
        )
        ...
        google.compute_instance.ComputeInstance(self, "instance_with_ip",
            ...
            network_interface=[ComputeInstanceNetworkInterface(
                access_config=[ComputeInstanceNetworkInterfaceAccessConfig(
                    nat_ip=cdktf.Token.as_string(google_compute_address_static.address)
                )
                ],
                network="default"
            )
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-b3ae4fba4d914b31fb71a5bfd7eef5eb97fefd5cd786b4e6816d27db9c0682ca -->