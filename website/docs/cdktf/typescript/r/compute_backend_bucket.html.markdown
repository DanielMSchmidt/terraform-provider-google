...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    const googleStorageBucketImageBucket =
      new google.storageBucket.StorageBucket(this, "image_bucket", {
        location: "EU",
    ...
    new google.computeBackendBucket.ComputeBackendBucket(
      ...
      "image_backend",
      {
        bucketName: cdktf.Token.asString(googleStorageBucketImageBucket.name),
