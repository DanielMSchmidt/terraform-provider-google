...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_ha_vpn_gateway.ComputeHaVpnGateway(self, "ha_gateway1",
            name="ha-vpn-1",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-d175ae9079234943591fe9c9e304448671814f9eec151bf8c09eeee38442a714 -->