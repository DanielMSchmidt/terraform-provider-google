...
create a `googleFirestoreDatabase` resource with `locationId` set to your
chosen location.
...
<a name="nested_index_config"></a>The `indexConfig` block supports:
...
* `queryScope` -
  ...
  Possible values are: `collection`, `collectionGroup`.
...
<a name="nested_ttl_config"></a>The `ttlConfig` block supports:
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-693806e0656c6b0f3a3734d7aec15743cdf42831cf2cee4ae82467f4dbe5f785 -->