...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.spanner_instance_iam_policy.SpannerInstanceIamPolicy(self, "instance",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.spanner_instance_iam_binding.SpannerInstanceIamBinding(self, "instance",
            instance="your-instance-name",
            members=["user:jane@example.com"],
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.spanner_instance_iam_member.SpannerInstanceIamMember(self, "instance",
            instance="your-instance-name",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-d288156e90c915be90597c5741654bc0c739c39eff5b7c9ea25090d0c1675fb9 -->