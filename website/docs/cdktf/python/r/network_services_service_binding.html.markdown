...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_service_directory_namespace_default =
        google.ServiceDirectoryNamespace(self, "default",
            location="us-central1",
            namespace_id="my-namespace",
            provider=google_beta
        )
        google_service_directory_service_default =
        google.ServiceDirectoryService(self, "default_1",
            metadata=[{
                "region": "us-central1",
                "stage": "prod"
            }
            ],
            namespace=google_service_directory_namespace_default.id,
            provider=google_beta,
            service_id="my-service"
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_service_directory_service_default.override_logical_id("default")
        google_network_services_service_binding_default =
        google.NetworkServicesServiceBinding(self, "default_2",
            ...
            provider=google_beta,
            service=google_service_directory_service_default.id
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_network_services_service_binding_default.override_logical_id("default")
```
