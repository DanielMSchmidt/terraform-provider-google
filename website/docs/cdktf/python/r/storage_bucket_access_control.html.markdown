...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.storage_bucket_access_control.StorageBucketAccessControl(self, "public_rule",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-a7cb76b02a46c4b9612d4cedc07badfec18aca149ec6713382c488edfc54b61e -->