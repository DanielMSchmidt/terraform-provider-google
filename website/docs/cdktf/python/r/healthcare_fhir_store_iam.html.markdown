...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.healthcare_fhir_store_iam_policy.HealthcareFhirStoreIamPolicy(self, "fhir_store",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.healthcare_fhir_store_iam_binding.HealthcareFhirStoreIamBinding(self, "fhir_store",
            fhir_store_id="your-fhir-store-id",
            members=["user:jane@example.com"],
            role="roles/editor"
        )
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.healthcare_fhir_store_iam_member.HealthcareFhirStoreIamMember(self, "fhir_store",
            fhir_store_id="your-fhir-store-id",
