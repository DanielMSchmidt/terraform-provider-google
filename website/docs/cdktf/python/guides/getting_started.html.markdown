...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.compute_instance.ComputeInstance(self, "vm_instance",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.compute_network.ComputeNetwork(self, "vpc_network",
            auto_create_subnetworks=cdktf.Token.as_boolean("true"),
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_network_vpc_network =
        google.compute_network.ComputeNetwork(self, "vpc_network",
            auto_create_subnetworks=cdktf.Token.as_boolean("true"),
            name="terraform-network"
        )
        google.compute_instance.ComputeInstance(self, "vm_instance",
            ...
            network_interface=[ComputeInstanceNetworkInterface(
                access_config=[ComputeInstanceNetworkInterfaceAccessConfig()],
                network=cdktf.Token.as_string(google_compute_network_vpc_network.self_link)
            )
            ]
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-68baa4c7299c805efa8ae83b4c56475a7df352c7b3019eec64753e73bb6efe4e -->