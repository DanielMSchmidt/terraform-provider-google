  ...
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleSecretManagerSecretVersionSecretVersion =
      new google.secretManagerSecretVersion.SecretManagerSecretVersion(
        ...
        {
          provider: googleBeta,
          secret: cdktf.Token.asString(googleSecretManagerSecretSecret.id),
          secretData: "secret-data",
        }
      );
    const googleSourcerepoRepositoryGitRepository =
      new google.sourcerepoRepository.SourcerepoRepository(
        this,
        "git_repository",
        {
          name: "my/repository",
    ...
    new google.DataformRepository(this, "dataform_respository", {
      git_remote_settings: [
        {
