...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.OrgPolicyCustomConstraint(this, "constraint", {
      action_type: "ALLOW",
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.OrgPolicyPolicy(this, "bool", {
      name:
        "organizations/123456789/policies/${" +
        googleOrgPolicyCustomConstraintConstraint.name +
        "}",
      parent: "organizations/123456789",
      provider: googleBeta,
      spec: [
