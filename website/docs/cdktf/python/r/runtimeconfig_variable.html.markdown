...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_runtimeconfig_config_my_runtime_config =
        google.runtimeconfig_config.RuntimeconfigConfig(self, "my-runtime-config",
            description="Runtime configuration values for my service",
            name="my-service-runtime-config"
        )
        google.runtimeconfig_variable.RuntimeconfigVariable(self, "environment",
            name="prod-variables/hostname",
            parent=cdktf.Token.as_string(google_runtimeconfig_config_my_runtime_config.name),
            text="example.com"
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-db6287e310c7238980ecf17f41735eb56a90d999347d981de0cb6b17f8702d5e -->