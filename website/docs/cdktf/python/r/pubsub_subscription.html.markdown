...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_pubsub_topic_example = google.pubsub_topic.PubsubTopic(self, "example",
            name="example-topic"
        )
        google_pubsub_subscription_example =
        google.pubsub_subscription.PubsubSubscription(self, "example_1",
            ...
            topic=cdktf.Token.as_string(google_pubsub_topic_example.name)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_pubsub_subscription_example.override_logical_id("example")
```
<div class = "oics-button" style="float: right; margin: 0 0 -15px">
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_pubsub_topic_example_dead_letter =
        google.pubsub_topic.PubsubTopic(self, "example_dead_letter",
            name="example-topic-dead-letter"
        )
        google_pubsub_subscription_example =
        google.pubsub_subscription.PubsubSubscription(self, "example_2",
            dead_letter_policy=PubsubSubscriptionDeadLetterPolicy(
                dead_letter_topic=cdktf.Token.as_string(google_pubsub_topic_example_dead_letter.id),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-b20499f48bdf21f42cb45aae5620a65ebb5541eac1317fa3b1cc0e50186439e9 -->