...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        random_id_rnd = random.id.Id(self, "rnd",
            byte_length=4
        )
        google.dns_managed_zone.DnsManagedZone(self, "example-zone",
            description="Example DNS zone",
            dns_name="example-${" + random_id_rnd.hex + "}.com.",
            labels={
                "foo": "bar"
            },
            name="example-zone"
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.dns_managed_zone.DnsManagedZone(self, "private-zone",
            ...
            private_visibility_config=DnsManagedZonePrivateVisibilityConfig(
                networks=[DnsManagedZonePrivateVisibilityConfigNetworks(
    ...
    def __init__(self, scope, name):
        ...
        google.dns_managed_zone.DnsManagedZone(self, "private-zone",
            ...
            forwarding_config=DnsManagedZoneForwardingConfig(
                target_name_servers=[DnsManagedZoneForwardingConfigTargetNameServers(
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_compute_network_network_source =
        google.compute_network.ComputeNetwork(self, "network-source",
            auto_create_subnetworks=False,
            name="network-source"
        )
        google_compute_network_network_target =
        google.compute_network.ComputeNetwork(self, "network-target",
            auto_create_subnetworks=False,
            name="network-target"
        )
        google.dns_managed_zone.DnsManagedZone(self, "peering-zone",
            description="Example private DNS peering zone",
            dns_name="peering.example.com.",
            name="peering-zone",
            peering_config=DnsManagedZonePeeringConfig(
                target_network=DnsManagedZonePeeringConfigTargetNetwork(
                    network_url=cdktf.Token.as_string(google_compute_network_network_target.id)
                )
            ),
            private_visibility_config=DnsManagedZonePrivateVisibilityConfig(
                networks=[DnsManagedZonePrivateVisibilityConfigNetworks(
                    network_url=cdktf.Token.as_string(google_compute_network_network_source.id)
                )
                ]
            ),
            visibility="private"
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_service_directory_namespace_example =
        google.ServiceDirectoryNamespace(self, "example",
            location="us-central1",
            namespace_id="example",
            provider=google_beta
        )
        google.dns_managed_zone.DnsManagedZone(self, "sd-zone",
            ...
            service_directory_config=[{
                "namespace": [{
                    "namespace_url": google_service_directory_namespace_example.id
                }
                ]
            }
            ],
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-7daccbe5c9f4dd2817c88c8696abfc272ed2d8e16a4b98cf281028ae40756fb8 -->