...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_storage_bucket_object_archive =
        google.storage_bucket_object.StorageBucketObject(self, "archive",
        ...
        google.cloudfunctions_function.CloudfunctionsFunction(self, "function",
            ...
            source_archive_object=cdktf.Token.as_string(google_storage_bucket_object_archive.name),
            trigger_http=True
        )
        google.cloudfunctions_function_iam_member.CloudfunctionsFunctionIamMember(self, "invoker",
            cloud_function=cdktf.Token.as_string(google_cloudfunctions_function_function.name),
            member="allUsers",
            project=cdktf.Token.as_string(google_cloudfunctions_function_function.project),
            region=cdktf.Token.as_string(google_cloudfunctions_function_function.region),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-416f0484fdc165bc5ab02bf44376ad4977a23467a43314b113855cdd1a6e1255 -->