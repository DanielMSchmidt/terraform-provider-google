...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_monitoring_group_check =
        google.monitoring_group.MonitoringGroup(self, "check",
            display_name="uptime-check-group",
            filter="resource.metadata.name=has_substring(\\\"foo\\\")"
        )
        google.monitoring_uptime_check_config.MonitoringUptimeCheckConfig(self, "tcp_group",
            display_name="tcp-uptime-check",
            resource_group=MonitoringUptimeCheckConfigResourceGroup(
                group_id=cdktf.Token.as_string(google_monitoring_group_check.name),
