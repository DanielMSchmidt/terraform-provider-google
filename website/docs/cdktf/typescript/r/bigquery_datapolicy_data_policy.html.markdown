...
* `dataPolicyType` -
  ...
  Possible values are: `columnLevelSecurityPolicy`, `dataMaskingPolicy`.
...
* `predefinedExpression` -
  ...
  Possible values are: `sha256`, `alwaysNull`, `defaultMaskingValue`, `lastFourCharacters`, `firstFourCharacters`, `emailMask`, `dateYearMask`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-90545dcac2a94c87e0ef62fac6463d0d8064c02475e02f9f39f1d5194d08814d -->