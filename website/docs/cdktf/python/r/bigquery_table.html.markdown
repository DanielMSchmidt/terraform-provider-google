...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_bigquery_dataset_default =
        google.bigquery_dataset.BigqueryDataset(self, "default",
            dataset_id="foo",
        ...
        google_bigquery_table_default = google.bigquery_table.BigqueryTable(self, "default_1",
            dataset_id=cdktf.Token.as_string(google_bigquery_dataset_default.dataset_id),
            labels={
                "env": "default"
            },
        ...
        google_bigquery_table_default.override_logical_id("default")
        google.bigquery_table.BigqueryTable(self, "sheet",
            dataset_id=cdktf.Token.as_string(google_bigquery_dataset_default.dataset_id),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-bcf14e116d27394d4b262801eb45a39b5f5d5cb4c528e0d16267a39e7041eca4 -->