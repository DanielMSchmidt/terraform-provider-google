...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
      ...
      "pyspark",
      {
        ...
        placement: {
          clusterName: cdktf.Token.asString(
            googleDataprocClusterMycluster.name
          ),
        },
        pysparkConfig: {
          mainPythonFileUri:
        ...
        region: cdktf.Token.asString(googleDataprocClusterMycluster.region),
      }
    );
    ...
    new cdktf.TerraformOutput(this, "pyspark_status", {
      value: cdktf.propertyAccess(googleDataprocJobPyspark.status, [
        "0",
        "state",
      ]),
    });
    new cdktf.TerraformOutput(this, "spark_status", {
      value: cdktf.propertyAccess(googleDataprocJobSpark.status, [
        "0",
        "state",
      ]),
    });
