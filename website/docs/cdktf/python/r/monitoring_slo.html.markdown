...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_monitoring_custom_service_customsrv =
        google.monitoring_custom_service.MonitoringCustomService(self, "customsrv",
            display_name="My Custom Service",
            service_id="custom-srv-request-slos"
        )
        google.monitoring_slo.MonitoringSlo(self, "request_based_slo",
            ...
            service=cdktf.Token.as_string(google_monitoring_custom_service_customsrv.service_id),
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.monitoring_slo.MonitoringSlo(self, "windows_based",
            ...
            windows_based_sli=MonitoringSloWindowsBasedSli(
                good_bad_metric_filter=cdktf.Fn.join(" AND ",
                    cdktf.Token.as_list(["metric.type=\\\"monitoring.googleapis.com/uptime_check/check_passed\\\"", "resource.type=\\\"uptime_url\\\""
                    ])),
                window_period="400s"
            )
        )
        ...
        google.monitoring_slo.MonitoringSlo(self, "windows_based",
            ...
            windows_based_sli=MonitoringSloWindowsBasedSli(
                metric_mean_in_range=MonitoringSloWindowsBasedSliMetricMeanInRange(
                    ...
                    time_series=cdktf.Fn.join(" AND ",
                        cdktf.Token.as_list(["metric.type=\\\"agent.googleapis.com/cassandra/client_request/latency/95p\\\"", "resource.type=\\\"gce_instance\\\""
                        ]))
                ),
                window_period="600s"
            )
        ...
        google.monitoring_slo.MonitoringSlo(self, "windows_based",
            ...
            windows_based_sli=MonitoringSloWindowsBasedSli(
                metric_sum_in_range=MonitoringSloWindowsBasedSliMetricSumInRange(
                    ...
                    time_series=cdktf.Fn.join(" AND ",
                        cdktf.Token.as_list(["metric.type=\\\"monitoring.googleapis.com/uptime_check/request_latency\\\"", "resource.type=\\\"uptime_url\\\""
                        ]))
                ),
                window_period="400s"
            )
                ...
                good_total_ratio_threshold=MonitoringSloWindowsBasedSliGoodTotalRatioThreshold(
                    performance=MonitoringSloWindowsBasedSliGoodTotalRatioThresholdPerformance(
                        distribution_cut=MonitoringSloWindowsBasedSliGoodTotalRatioThresholdPerformanceDistributionCut(
                            distribution_filter=cdktf.Fn.join(" AND ",
                                cdktf.Token.as_list(["metric.type=\\\"serviceruntime.googleapis.com/api/request_latencies\\\"", "resource.type=\\\"consumed_api\\\""
                                ])),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-efa512674c4a0d0336e5fe5ccbae2930b43426b4b3ccf7297a188dc72688d75e -->