...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.redis_instance.RedisInstance(self, "cache",
            memory_size_gb=1,
            name="memory-cache"
        )
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        data_google_compute_network_redis_network =
        google.data_google_compute_network.DataGoogleComputeNetwork(self, "redis-network",
            name="redis-test-network"
        )
        ...
        google.compute_global_address.ComputeGlobalAddress(self, "service_range",
            ...
            name="address",
            network=cdktf.Token.as_string(data_google_compute_network_redis_network.id),
            prefix_length=16,
            purpose="VPC_PEERING"
        )
        ...
        google.redis_instance.RedisInstance(self, "cache",
            alternative_location_id="us-central1-f",
            authorized_network=cdktf.Token.as_string(data_google_compute_network_redis_network.id),
            connect_mode="PRIVATE_SERVICE_ACCESS",
            depends_on=[google_service_networking_connection_private_service_connection],
            display_name="Terraform Test Instance",
            location_id="us-central1-a",
            memory_size_gb=1,
            name="private-cache",
