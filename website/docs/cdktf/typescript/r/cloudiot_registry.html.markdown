...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    const googlePubsubTopicDefaultTelemetry =
      new google.pubsubTopic.PubsubTopic(this, "default-telemetry", {
        name: "default-telemetry",
      });
    new google.cloudiotRegistry.CloudiotRegistry(this, "test-registry", {
      eventNotificationConfigs: [
        {
          pubsubTopicName: cdktf.Token.asString(
            googlePubsubTopicDefaultTelemetry.id
          ),
          subfolderMatches: "",
        },
      ],
