...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_network_security_gateway_security_policy_rule_default =
        google.NetworkSecurityGatewaySecurityPolicyRule(self, "default_1",
            basic_profile="ALLOW",
            description="my description",
            enabled=True,
            gateway_security_policy=google_network_security_gateway_security_policy_default.name,
            location="us-central1",
        ...
        google_network_security_gateway_security_policy_rule_default.override_logical_id("default")
```
<div class = "oics-button" style="float: right; margin: 0 0 -15px">
