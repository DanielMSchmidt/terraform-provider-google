...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.CloudRunV2Service(this, "default", {
      ingress: "INGRESS_TRAFFIC_ALL",
      launch_stage: "BETA",
      lifecycle: {
        ignoreChanges: [launchStage],
      },
      location: "us-central1",
      name: "cloudrun-service",
      provider: googleBeta,
...
* `executionEnvironment` -
  ...
  Possible values are: `executionEnvironmentGen1`, `executionEnvironmentGen2`.
...
* `egress` -
  ...
  Possible values are: `allTraffic`, `privateRangesOnly`.
...
* `ingress` -
  ...
  Possible values are: `ingressTrafficAll`, `ingressTrafficInternalOnly`, `ingressTrafficInternalLoadBalancer`.
...
* `launchStage` -
  ...
  Possible values are: `unimplemented`, `prelaunch`, `earlyAccess`, `alpha`, `beta`, `ga`, `deprecated`.
...
* `type` -
  ...
  Possible values are: `trafficTargetAllocationTypeLatest`, `trafficTargetAllocationTypeRevision`.
...
<a name="nested_traffic_statuses"></a>The `trafficStatuses` block contains:
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-67912e1105e7c326f03031e94f1cc3a57c2d0dea5b8c1b7037244585d8ad82b5 -->