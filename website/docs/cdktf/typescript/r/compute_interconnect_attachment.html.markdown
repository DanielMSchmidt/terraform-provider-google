  ...
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleComputeRouterFoobar = new google.computeRouter.ComputeRouter(
      ...
      "foobar_1",
      {
        ...
        name: "router-1",
        network: cdktf.Token.asString(googleComputeNetworkFoobar.name),
      }
    );
    ...
    new google.computeInterconnectAttachment.ComputeInterconnectAttachment(
      ...
      "on_prem",
      {
        ...
        mtu: cdktf.Token.asString(1500),
        name: "on-prem-attachment",
        router: cdktf.Token.asString(googleComputeRouterFoobar.id),
        type: "PARTNER",
      }
    );
  }
...
* `bandwidth` -
  ...
  Defaults to BPS_10G
  Possible values are: `bps50M`, `bps100M`, `bps200M`, `bps300M`, `bps400M`, `bps500M`, `bps1G`, `bps2G`, `bps5G`, `bps10G`, `bps20G`, `bps50G`.
...
* `type` -
  ...
  DEDICATED.
  Possible values are: `dedicated`, `partner`, `partnerProvider`.
