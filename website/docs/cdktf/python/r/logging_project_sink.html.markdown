...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.logging_project_sink.LoggingProjectSink(self, "my-sink",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.logging_project_sink.LoggingProjectSink(self, "log-bucket",
            destination="logging.googleapis.com/projects/my-project/locations/global/buckets/_Default",
            exclusions=[LoggingProjectSinkExclusions(
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-430fc76e98ec5e8eb3c230fc7349463d7af79c4023e89a9762545233d06ae22b -->