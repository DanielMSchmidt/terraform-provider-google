...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.OsConfigGuestPolicies(self, "guest_policies",
            assignment=[{
                "instances": [google_compute_instance_foobar.id]
            }
            ],
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-ce8a15fa95215ce529298cbfbd822958ca2d7e7922e7875813c0cc4a364a543c -->