...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.binaryAuthorizationPolicy.BinaryAuthorizationPolicy(
      this,
      "policy",
      {
        ...
        clusterAdmissionRules: [
          {
            ...
            requireAttestationsBy: [
              cdktf.Token.asString(
                googleBinaryAuthorizationAttestorAttestor.name
              ),
            ],
          },
        ],
...
* `evaluationMode` -
  ...
  Possible values are: `alwaysAllow`, `requireAttestation`, `alwaysDeny`.
...
* `enforcementMode` -
  ...
  Possible values are: `enforcedBlockAndAuditLog`, `dryrunAuditLogOnly`.
