...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.provider.GoogleProvider(self, "google",
            scopes=["https://www.googleapis.com/auth/compute", "https://www.googleapis.com/auth/cloud-platform", "https://www.googleapis.com/auth/ndev.clouddns.readwrite", "https://www.googleapis.com/auth/devstorage.full_control", "https://www.googleapis.com/auth/userinfo.email"
            ]
        )
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.container_cluster.ContainerCluster(self, "primary",
            initial_node_count=1,
            location="us-central1",
            name="my-cluster"
        )
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_subnetwork.ComputeSubnetwork(self, "container_subnetwork",
            ...
            network=cdktf.Token.as_string(google_compute_network_container_network.self_link),
            region="us-central1"
        )
        google.container_cluster.ContainerCluster(self, "primary",
            initial_node_count=1,
...
import constructs as constructs
import cdktf as cdktf
import ...gen.modules.terraform_google_modules.google.project_factory.modules.project_services as ProjectServices
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        ProjectServices.ProjectServices(self, "project_services",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_project_service_service_for_each_iterator =
        cdktf.TerraformIterator.from_list(
            cdktf.Token.as_any(
                cdktf.Fn.toset(["iam.googleapis.com", "cloudresourcemanager.googleapis.com"
                ])))
        google.project_service.ProjectService(self, "service",
            disable_on_destroy=False,
            project="your-project-id",
            service=cdktf.Token.as_string(google_project_service_service_for_each_iterator.key),
            for_each=google_project_service_service_for_each_iterator
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-6ff0c66702a7f339d1ce5508910d9378e1757227e2ea5b47feab08cbbf981b3c -->