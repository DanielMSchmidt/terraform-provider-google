  ...
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleComputeBackendBucketStatic =
      new google.computeBackendBucket.ComputeBackendBucket(this, "static_2", {
        bucketName: cdktf.Token.asString(googleStorageBucketStatic.name),
        enableCdn: true,
    ...
    new google.computeUrlMap.ComputeUrlMap(this, "urlmap", {
      defaultService: cdktf.Token.asString(googleComputeBackendBucketStatic.id),
      ...
      pathMatcher: [
        {
          defaultService: cdktf.Token.asString(
            googleComputeBackendBucketStatic.id
          ),
          name: "mysite",
          pathRule: [
            {
            ...
            },
            {
              paths: ["/login"],
              service: cdktf.Token.asString(
                googleComputeBackendServiceLogin.id
              ),
            },
            {
              paths: ["/static"],
      ...
      test: [
        {
          host: "example.com",
          path: "/home",
          service: cdktf.Token.asString(googleComputeBackendBucketStatic.id),
        },
      ],
    });
  }
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.computeUrlMap.ComputeUrlMap(this, "urlmap", {
      defaultService: cdktf.Token.asString(googleComputeBackendServiceHome.id),
      description: "a description",
      hostRule: [
        {
          hosts: ["mysite.com"],
              ...
              routeAction: {
                ...
                faultInjectionPolicy: {
                  ...
                  delay: {
                    fixedDelay: {
                      nanos: 50000,
                      seconds: cdktf.Token.asString(0),
                    },
                    percentage: 7.8,
                  },
                },
                ...
                retryPolicy: {
                  numRetries: 4,
                  perTryTimeout: {
                    seconds: cdktf.Token.asString(30),
                  },
                  retryConditions: ["5xx", "deadline-exceeded"],
                },
                timeout: {
                  nanos: 750000000,
                  seconds: cdktf.Token.asString(20),
                },
                urlRewrite: {
                ...
                weightedBackendServices: [
                  {
                    ...
                    headerAction: {
                      ...
                      requestHeadersToRemove: ["RemoveMe"],
                      responseHeadersToAdd: [
                        {
                          headerName: "AddMe",
                          headerValue: "MyValue",
                      ...
                      responseHeadersToRemove: ["RemoveMe"],
                    },
                    weight: 400,
                  },
                ],
          ...
          routeRules: [
            {
              ...
              priority: 1,
              service: cdktf.Token.asString(
                googleComputeBackendServiceServiceA.id
              ),
            },
            {
              matchRules: [
              ...
              priority: 2,
              service: cdktf.Token.asString(
                googleComputeBackendServiceServiceB.id
              ),
            },
          ],
        },
...
* `filterMatchCriteria` -
  ...
  Possible values are: `matchAll`, `matchAny`.
