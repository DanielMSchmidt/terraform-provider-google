...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    const googleBigqueryDatasetTest =
      new google.bigqueryDataset.BigqueryDataset(this, "test", {
        datasetId: "dataset_id",
      });
    new google.bigqueryRoutine.BigqueryRoutine(this, "sproc", {
      datasetId: cdktf.Token.asString(googleBigqueryDatasetTest.datasetId),
      definitionBody:
...
* `routineType` -
  (Optional)
  The type of routine.
  Possible values are: `scalarFunction`, `procedure`, `tableValuedFunction`.
...
* `determinismLevel` -
  ...
  Possible values are: `determinismLevelUnspecified`, `deterministic`, `notDeterministic`.
...
* `argumentKind` -
  ...
  Possible values are: `fixedType`, `anyType`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-9ba98bb4da7c5098418c21884ef31cf5cbba80baa2c5231bbbdba3090d80f4ab -->