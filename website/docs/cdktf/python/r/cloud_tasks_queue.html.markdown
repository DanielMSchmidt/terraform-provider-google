...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.cloud_tasks_queue.CloudTasksQueue(self, "default",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.cloud_tasks_queue.CloudTasksQueue(self, "advanced_configuration",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-844a5ff2ae7397efe12927bc0c827cb6b269571bb53b332380f288bb76dae31e -->