...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_network_endpoint_group.ComputeNetworkEndpointGroup(self, "neg",
            default_port=cdktf.Token.as_number("90"),
            name="my-lb-neg",
            network=cdktf.Token.as_string(google_compute_network_default.id),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-f36cb6b737f43b7738d51b129ce073be2c6968caf6f9d809b94bc6fd5e2d7f6f -->