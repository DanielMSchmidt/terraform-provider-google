...
values will be stored in the raw state as plain text: `iapOauth2ClientSecret`, `iapOauth2ClientSecretSha256`.
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.computeBackendService.ComputeBackendService(this, "default", {
      healthChecks: [
        cdktf.Token.asString(googleComputeHealthCheckHealthCheck.id),
      ],
  ...
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleComputeGlobalNetworkEndpointGroupExternalProxy =
      new google.computeGlobalNetworkEndpointGroup.ComputeGlobalNetworkEndpointGroup(
        ...
        "external_proxy",
        {
          defaultPort: cdktf.Token.asNumber("443"),
    ...
    const googleComputeGlobalNetworkEndpointProxy =
      new google.computeGlobalNetworkEndpoint.ComputeGlobalNetworkEndpoint(
        ...
        "proxy",
        {
          ...
          globalNetworkEndpointGroup: cdktf.Token.asString(
            googleComputeGlobalNetworkEndpointGroupExternalProxy.id
          ),
          port: cdktf.Token.asNumber(
            googleComputeGlobalNetworkEndpointGroupExternalProxy.defaultPort
          ),
          provider: googleBeta,
        }
      );
...
* `loadBalancingScheme` -
  ...
  Possible values are: `external`, `internalSelfManaged`, `externalManaged`.
...
* `localityLbPolicy` -
  ...
  * A regional backend service with loadBalancingScheme set to EXTERNAL (External Network
  ...
  field set to true.
  Possible values are: `roundRobin`, `leastRequest`, `ringHash`, `random`, `originalDestination`, `maglev`, `weightedMaglev`.
...
* `sessionAffinity` -
  ...
  Possible values are: `none`, `clientIp`, `clientIpPortProto`, `clientIpProto`, `generatedCookie`, `headerField`, `httpCookie`.
...
* `cacheMode` -
  ...
  Possible values are: `useOriginHeaders`, `forceCacheAll`, `cacheAllStatic`.
...
* `name` -
  ...
  * `maglev`: used as a drop in replacement for the ring hash load balancer.
              ...
              build times and host selection times. For more information about
              Maglev, refer to https://ai.google/research/pubs/pub44824
  Possible values are: `roundRobin`, `leastRequest`, `ringHash`, `random`, `originalDestination`, `maglev`.
