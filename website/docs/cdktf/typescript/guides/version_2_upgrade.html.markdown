...
in a `1X` series release on `terraform init`.
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.cloudbuildTrigger.CloudbuildTrigger(this, "build_trigger", {
      ...
      triggerTemplate: {
        branchName: "main-updated",
        repoName: "some-repo-updated",
      },
    });
  }
}
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.computeSnapshot.ComputeSnapshot(this, "my_snapshot", {
      ...
      sourceDisk: cdktf.Token.asString(googleComputeDiskMyDisk.name),
      zone: "us-central1-a",
    });
  }
}
