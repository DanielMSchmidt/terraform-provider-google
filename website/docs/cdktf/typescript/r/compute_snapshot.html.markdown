...
values will be stored in the raw state as plain text: `snapshotEncryptionKeyRawKey`, `sourceDiskEncryptionKeyRawKey`.
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleComputeDiskPersistent = new google.computeDisk.ComputeDisk(
      ...
      "persistent",
      {
        image: cdktf.Token.asString(dataGoogleComputeImageDebian.selfLink),
        name: "debian-disk",
        size: 10,
        type: "pd-ssd",
        zone: "us-central1-a",
    ...
    new google.computeSnapshot.ComputeSnapshot(this, "snapshot", {
      ...
      name: "my-snapshot",
      sourceDisk: cdktf.Token.asString(googleComputeDiskPersistent.id),
...
<a name="nested_source_disk_encryption_key"></a>The `sourceDiskEncryptionKey` block supports:
