...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.game_services_game_server_config.GameServicesGameServerConfig(self, "default_1",
            ...
            scaling_configs=[GameServicesGameServerConfigScalingConfigs(
                fleet_autoscaler_spec=cdktf.Fn.jsonencode({
                    "policy": {
                        "type": "Webhook",
                        "webhook": {
                            "service": {
                ...
                schedules=[GameServicesGameServerConfigScalingConfigsSchedules(
                    cron_job_duration="3.500s",
                    cron_spec="0 0 * * 0"
                )
                ],
                selectors=[GameServicesGameServerConfigScalingConfigsSelectors(
                    labels={
                        "one": "two"
                    }
                )
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-a4777e759644cb1543ae4f52862ae04d442385ccd5b23d6d7e91e363107f964b -->