...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.healthcareDicomStore.HealthcareDicomStore(this, "default", {
      ...
      notificationConfig: {
        pubsubTopic: cdktf.Token.asString(googlePubsubTopicTopic.id),
      },
    });
  }
}
    ...
    const googleBigqueryTableBqTable = new google.bigqueryTable.BigqueryTable(
      ...
      "bq_table",
      {
        datasetId: cdktf.Token.asString(
          googleBigqueryDatasetBqDataset.datasetId
        ),
          ...
          bigquery_destination: [
            {
              table_uri:
                "bq://${" +
                googleBigqueryDatasetBqDataset.project +
                "}.${" +
                googleBigqueryDatasetBqDataset.datasetId +
                "}.${" +
                googleBigqueryTableBqTable.tableId +
                "}",
            },
          ],
        },
