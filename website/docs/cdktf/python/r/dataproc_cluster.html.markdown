...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.dataproc_cluster.DataprocCluster(self, "simplecluster",
            name="simplecluster",
            region="us-central1"
        )
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.dataproc_cluster.DataprocCluster(self, "mycluster",
            cluster_config=DataprocClusterClusterConfig(
                gce_cluster_config=DataprocClusterClusterConfigGceClusterConfig(
                    service_account=cdktf.Token.as_string(google_service_account_default.email),
                    service_account_scopes=["cloud-platform"],
                    tags=["foo", "bar"]
                ),
                initialization_action=[DataprocClusterClusterConfigInitializationAction(
                    script="gs://dataproc-initialization-actions/stackdriver/stackdriver.sh",
                    timeout_sec=500
                )
                ],
                master_config=DataprocClusterClusterConfigMasterConfig(
                    disk_config=DataprocClusterClusterConfigMasterConfigDiskConfig(
                ...
                software_config=DataprocClusterClusterConfigSoftwareConfig(
                ...
                worker_config=DataprocClusterClusterConfigWorkerConfig(
                    disk_config=DataprocClusterClusterConfigWorkerConfigDiskConfig(
                        boot_disk_size_gb=30,
                        num_local_ssds=1
                    ),
                    machine_type="e2-medium",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.dataproc_cluster.DataprocCluster(self, "accelerated_cluster",
            cluster_config=DataprocClusterClusterConfig(
                gce_cluster_config=DataprocClusterClusterConfigGceClusterConfig(
                    zone="us-central1-a"
                ),
                master_config=DataprocClusterClusterConfigMasterConfig(
                    accelerators=[DataprocClusterClusterConfigMasterConfigAccelerators(
                        accelerator_count=cdktf.Token.as_number("1"),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e56e9e00934f5cb14586ae1c52ba9cc81ded93da9fab8bc752bd4c1d8aabd032 -->