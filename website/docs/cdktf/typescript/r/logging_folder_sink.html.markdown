  ...
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleLoggingFolderSinkMySink =
      new google.loggingFolderSink.LoggingFolderSink(this, "my-sink", {
        ...
        destination:
          "storage.googleapis.com/${" + googleStorageBucketLogBucket.name + "}",
        filter: "resource.type = gce_instance AND severity >= WARNING",
        folder: cdktf.Token.asString(googleFolderMyFolder.name),
        name: "my-sink",
      });
    new google.projectIamBinding.ProjectIamBinding(this, "log-writer", {
      members: [
        cdktf.Token.asString(googleLoggingFolderSinkMySink.writerIdentity),
      ],
