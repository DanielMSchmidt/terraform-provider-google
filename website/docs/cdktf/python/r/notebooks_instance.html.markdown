...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.notebooks_instance.NotebooksInstance(self, "instance",
            location="us-west1-a",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        data_google_compute_network_my_network =
        google.data_google_compute_network.DataGoogleComputeNetwork(self, "my_network",
            name="default"
        )
        data_google_compute_subnetwork_my_subnetwork =
        google.data_google_compute_subnetwork.DataGoogleComputeSubnetwork(self, "my_subnetwork",
            name="default",
            region="us-central1"
        )
        google.notebooks_instance.NotebooksInstance(self, "instance",
            ...
            name="notebooks-instance",
            network=cdktf.Token.as_string(data_google_compute_network_my_network.id),
            no_proxy_access=True,
            no_public_ip=True,
            service_account="my@service-account.com",
            subnet=cdktf.Token.as_string(data_google_compute_subnetwork_my_subnetwork.id),
            vm_image=NotebooksInstanceVmImage(
                image_family="tf-latest-cpu",
                project="deeplearning-platform-release"
            )
