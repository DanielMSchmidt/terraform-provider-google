...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_address_scanner_static_ip =
        google.compute_address.ComputeAddress(self, "scanner_static_ip",
            name="scan-basic-static-ip",
            provider=google_beta
        )
        google.SecurityScannerScanConfig(self, "scan-config",
            display_name="terraform-scan-config",
            provider=google_beta,
            starting_urls=["http://${" + google_compute_address_scanner_static_ip.address + "}"
            ],
