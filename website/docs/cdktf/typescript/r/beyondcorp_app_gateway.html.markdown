...
* `type` -
  ...
  Possible values are: `typeUnspecified`, `tcpProxy`.

* `hostType` -
  (Optional)
  The type of hosting used by the AppGateway.
  Default value is `hostTypeUnspecified`.
  Possible values are: `hostTypeUnspecified`, `gcpRegionalMig`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-b81471bf8045676bc3174a20b91f34659aee7eb9f4e456081793e36ee13fc068 -->