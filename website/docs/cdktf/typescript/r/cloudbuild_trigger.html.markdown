...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleCloudbuildv2ConnectionMyConnection =
      new google.Cloudbuildv2Connection(this, "my-connection", {
        github_config: [
          {
    ...
    const googleCloudbuildv2RepositoryMyRepository =
      new google.Cloudbuildv2Repository(this, "my-repository", {
        name: "my-repo",
...
* `includeBuildLogs` -
  ...
  Possible values are: `includeBuildLogsUnspecified`, `includeBuildLogsWithStatus`.
...
* `repoType` -
  ...
  Possible values are: `unknown`, `cloudSourceRepositories`, `github`, `bitbucketServer`.
...
* `commentControl` -
  ...
  Possible values are: `commentsDisabled`, `commentsEnabled`, `commentsEnabledForExternalContributorsOnly`.
...
* `requestedVerifyOption` -
  ...
  Possible values are: `notVerified`, `verified`.

* `machineType` -
  (Optional)
  Compute Engine machine type on which to run the build.
  Possible values are: `unspecified`, `n1Highcpu8`, `n1Highcpu32`, `e2Highcpu8`, `e2Highcpu32`.
...
* `substitutionOption` -
  ...
  Possible values are: `mustMatch`, `allowLoose`.
...
* `logStreamingOption` -
  ...
  Possible values are: `streamDefault`, `streamOn`, `streamOff`.
...
* `logging` -
  ...
  Possible values are: `loggingUnspecified`, `legacy`, `gcsOnly`, `stackdriverOnly`, `cloudLoggingOnly`, `none`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-df4f051f6b1dbd83f94028d0613ce1880e8240a74aac2bbb309fcd3c04a42085 -->