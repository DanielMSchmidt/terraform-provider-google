...
* `ingressTrafficAllowed` -
  ...
  Possible values are: `ingressTrafficAllowedUnspecified`, `ingressTrafficAllowedAll`, `ingressTrafficAllowedInternalOnly`, `ingressTrafficAllowedInternalAndLb`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-324060888c52994626b598c3e3604b364ac15a23c450460be5dac993704d03d5 -->