...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.data_google_compute_region_instance_group.DataGoogleComputeRegionInstanceGroup(self, "group",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-175d8f619101c88b3564211c3e3d44417e61cfd1afbdaef8f0e0e4299c8cd0cf -->