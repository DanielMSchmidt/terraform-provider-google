  ...
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleComputeInstanceTargetVm =
      new google.computeInstance.ComputeInstance(this, "target-vm", {
        bootDisk: {
          initializeParams: {
            image: cdktf.Token.asString(dataGoogleComputeImageVmimage.selfLink),
          },
        },
    ...
    new google.computeTargetInstance.ComputeTargetInstance(this, "default", {
      instance: cdktf.Token.asString(googleComputeInstanceTargetVm.id),
      name: "target",
    });
  }
}
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.computeTargetInstance.ComputeTargetInstance(
      this,
      "custom_network",
      {
        instance: cdktf.Token.asString(googleComputeInstanceTargetVm.id),
