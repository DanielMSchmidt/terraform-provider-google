...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.NetworkServicesGrpcRoute(this, "default", {
...
* `type` -
  ...
  Possible values are: `typeUnspecified`, `exact`, `regularExpression`.
...
* `retryConditions` -
  ...
  Each value may be one of: `connectFailure`, `refusedStream`, `cancelled`, `deadlineExceeded`, `resourceExhausted`, `unavailable`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-a9df1263501adec78867b12e214c4e16eb2f13859c53a1e0328ce27c515b044e -->