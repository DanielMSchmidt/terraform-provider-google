...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.GkeonpremVmwareCluster(this, "cluster-basic", {
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.GkeonpremVmwareCluster(this, "cluster-f5lb", {
      admin_cluster_membership:
        "projects/870316890899/locations/global/memberships/gkeonprem-terraform-test",
      annotations: [{}],
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.GkeonpremVmwareCluster(this, "cluster-manuallb", {
      admin_cluster_membership:
        "projects/870316890899/locations/global/memberships/gkeonprem-terraform-test",
      annotations: [{}],
      anti_affinity_groups: [
...
<a name="nested_control_plane_node"></a>The `controlPlaneNode` block supports:
...
<a name="nested_auto_resize_config"></a>The `autoResizeConfig` block supports:
...
<a name="nested_anti_affinity_groups"></a>The `antiAffinityGroups` block supports:
...
<a name="nested_static_ip_config"></a>The `staticIpConfig` block supports:
...
<a name="nested_ip_blocks"></a>The `ipBlocks` block supports:
...
<a name="nested_dhcp_ip_config"></a>The `dhcpIpConfig` block supports:
...
<a name="nested_host_config"></a>The `hostConfig` block supports:
...
<a name="nested_control_plane_v2_config"></a>The `controlPlaneV2Config` block supports:
...
<a name="nested_control_plane_ip_block"></a>The `controlPlaneIpBlock` block supports:
...
<a name="nested_f5_config"></a>The `f5Config` block supports:
...
<a name="nested_dataplane_v2"></a>The `dataplaneV2` block supports:
...
<a name="nested_auto_repair_config"></a>The `autoRepairConfig` block supports:
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-bde5faa643093e6160f7038ff5c7e91adb4d14844482ea1f2d0309e361f79fba -->