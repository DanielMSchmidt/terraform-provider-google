...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_folder_default = google.folder.Folder(self, "default",
            display_name="some-folder-name",
            parent="organizations/123456789"
        )
        google.logging_folder_bucket_config.LoggingFolderBucketConfig(self, "basic",
            bucket_id="_Default",
            folder=cdktf.Token.as_string(google_folder_default.name),
            location="global",
            retention_days=30
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-67babe081339a6059d7134135bf350d731644e17ab8851260b061dc19186896f -->