...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
            ...
            template=CloudRunServiceTemplate(
                spec=CloudRunServiceTemplateSpec(
                    ...
                    containers=[CloudRunServiceTemplateSpecContainers(
                        ...
                        ports=[CloudRunServiceTemplateSpecContainersPorts(
                            container_port=8080
                        )
                        ]
                    )
        ...
        google.eventarc_trigger.EventarcTrigger(self, "primary",
            ...
            location="europe-west1",
            matching_criteria=[EventarcTriggerMatchingCriteria(
                attribute="type",
        ...
        google.pubsub_topic.PubsubTopic(self, "foo",
            name="topic"
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-13246e85036cb6256221c31c86a9ef598ed6eb3fade15ac611b1e2df39987664 -->