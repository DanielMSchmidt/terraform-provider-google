...
* `state` -
  ...
  Possible values are: `pendingGeneration`, `enabled`, `disabled`, `destroyed`, `destroyScheduled`, `pendingImport`, `importFailed`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e916b024c23d8a451b33e2aeda50e6f483cb28405773b23cbfae9399e0465d88 -->