...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_compute_health_check_health_check =
        google.compute_health_check.ComputeHealthCheck(self, "health_check",
        ...
        google.compute_backend_service.ComputeBackendService(self, "default",
            health_checks=[
                cdktf.Token.as_string(google_compute_health_check_health_check.id)
            ],
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_compute_global_network_endpoint_group_external_proxy =
        google.compute_global_network_endpoint_group.ComputeGlobalNetworkEndpointGroup(self, "external_proxy",
            default_port=cdktf.Token.as_number("443"),
            name="network-endpoint",
            network_endpoint_type="INTERNET_FQDN_PORT",
            provider=google_beta
        )
        google_compute_global_network_endpoint_proxy =
        google.compute_global_network_endpoint.ComputeGlobalNetworkEndpoint(self, "proxy",
            fqdn="test.example.com",
            global_network_endpoint_group=cdktf.Token.as_string(google_compute_global_network_endpoint_group_external_proxy.id),
            port=cdktf.Token.as_number(google_compute_global_network_endpoint_group_external_proxy.default_port),
            provider=google_beta
        )
        google.compute_backend_service.ComputeBackendService(self, "default",
            backend=[ComputeBackendServiceBackend(
                group=cdktf.Token.as_string(google_compute_global_network_endpoint_group_external_proxy.id)
            )
            ],
            connection_draining_timeout_sec=10,
            custom_request_headers=["host: ${" + google_compute_global_network_endpoint_proxy.fqdn + "}"
            ],
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-bc4f095ffe9ddc05bcd7004ab14a09ee7d2ea255c974926fd7a2cff370b12561 -->