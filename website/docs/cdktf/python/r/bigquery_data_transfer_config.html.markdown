...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_project_iam_member_permissions =
        google.project_iam_member.ProjectIamMember(self, "permissions",
            member="serviceAccount:service-${" + data_google_project_project.number + "}@gcp-sa-bigquerydatatransfer.iam.gserviceaccount.com",
            project=cdktf.Token.as_string(data_google_project_project.project_id),
            role="roles/iam.serviceAccountTokenCreator"
        )
        google_bigquery_dataset_my_dataset =
        google.bigquery_dataset.BigqueryDataset(self, "my_dataset",
            dataset_id="my_dataset",
            depends_on=[google_project_iam_member_permissions],
            description="bar",
            friendly_name="foo",
            location="asia-northeast1"
        )
        google.bigquery_data_transfer_config.BigqueryDataTransferConfig(self, "query_config",
            data_source_id="scheduled_query",
            depends_on=[google_project_iam_member_permissions],
            destination_dataset_id=cdktf.Token.as_string(google_bigquery_dataset_my_dataset.dataset_id),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-225f6c5e8d2636ce83e9a54a548a013a93fbc190fa84a115a714e78b665bc193 -->