    ...
    const googleComputeTargetHttpsProxyDefault =
      new google.computeTargetHttpsProxy.ComputeTargetHttpsProxy(
        ...
        "default_4",
        {
          name: "test-proxy",
          sslCertificates: [
            cdktf.Token.asString(googleComputeManagedSslCertificateDefault.id),
          ],
    ...
    const googleComputeGlobalForwardingRuleDefault =
      new google.computeGlobalForwardingRule.ComputeGlobalForwardingRule(
        ...
        "default_5",
        {
          ...
          portRange: cdktf.Token.asString(443),
          target: cdktf.Token.asString(googleComputeTargetHttpsProxyDefault.id),
        }
      );
    /*This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.*/
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const managedDomains = cdktf.Fn.tolist(["test.example.com"]);
    const googleComputeHttpHealthCheckDefault =
      new google.computeHttpHealthCheck.ComputeHttpHealthCheck(
        this,
        "default",
    ...
    const randomIdCertificate = new random.id.Id(this, "certificate", {
      ...
      keepers: [
        {
          domains: cdktf.Fn.join(",", cdktf.Token.asList(managedDomains)),
        },
      ],
    ...
    const googleComputeManagedSslCertificateCert =
      new google.computeManagedSslCertificate.ComputeManagedSslCertificate(
        ...
        "cert",
        {
          ...
          managed: {
            domains: cdktf.Token.asList(managedDomains),
          },
          name: cdktf.Token.asString(randomIdCertificate.hex),
        }
      );
    const googleComputeUrlMapDefault = new google.computeUrlMap.ComputeUrlMap(
      this,
    ...
    const googleComputeTargetHttpsProxyDefault =
      new google.computeTargetHttpsProxy.ComputeTargetHttpsProxy(
        ...
        "default_5",
        {
          name: "test-proxy",
          sslCertificates: [
            cdktf.Token.asString(googleComputeManagedSslCertificateCert.id),
          ],
          urlMap: cdktf.Token.asString(googleComputeUrlMapDefault.id),
        }
      );
