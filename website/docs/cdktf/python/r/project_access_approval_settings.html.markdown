...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.project_access_approval_settings.ProjectAccessApprovalSettings(self, "project_access_approval",
            enrolled_services=[ProjectAccessApprovalSettingsEnrolledServices(
                cloud_product="all",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-becc85051446bf236c16634a11149f5454e46c511dd364d1c3c1d69384e1bf97 -->