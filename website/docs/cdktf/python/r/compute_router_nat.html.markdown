...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_network_net = google.compute_network.ComputeNetwork(self, "net",
            name="my-network"
        )
        ...
        google.compute_subnetwork.ComputeSubnetwork(self, "subnet",
            ...
            name="my-subnetwork",
            network=cdktf.Token.as_string(google_compute_network_net.id),
            region="us-central1"
        )
        google_compute_router_router = google.compute_router.ComputeRouter(self, "router",
            bgp=ComputeRouterBgp(
                asn=64514
            ),
            name="my-router",
            network=cdktf.Token.as_string(google_compute_network_net.id),
            region=cdktf.Token.as_string(google_compute_subnetwork_subnet.region)
        )
        google.compute_router_nat.ComputeRouterNat(self, "nat",
            ...
            region=cdktf.Token.as_string(google_compute_router_router.region),
            router=cdktf.Token.as_string(google_compute_router_router.name),
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_address_address_count = cdktf.TerraformCount.of(
            cdktf.Token.as_number("2"))
        google_compute_address_address =
        google.compute_address.ComputeAddress(self, "address",
            name="nat-manual-ip-${" + google_compute_address_address_count.index + "}",
            region=cdktf.Token.as_string(google_compute_subnetwork_subnet.region),
            count=google_compute_address_address_count
        )
        google_compute_router_router = google.compute_router.ComputeRouter(self, "router",
            name="my-router",
            network=cdktf.Token.as_string(google_compute_network_net.id),
        ...
        google.compute_router_nat.ComputeRouterNat(self, "nat_manual",
            name="my-router-nat",
            nat_ip_allocate_option="MANUAL_ONLY",
            nat_ips=cdktf.Token.as_list(
                cdktf.property_access(google_compute_address_address, ["*", "self_link"])),
            region=cdktf.Token.as_string(google_compute_router_router.region),
            router=cdktf.Token.as_string(google_compute_router_router.name),
            source_subnetwork_ip_ranges_to_nat="LIST_OF_SUBNETWORKS",
            subnetwork=[ComputeRouterNatSubnetwork(
                name=cdktf.Token.as_string(google_compute_subnetwork_subnet.id),
