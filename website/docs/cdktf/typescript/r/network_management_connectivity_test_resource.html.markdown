  ...
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleComputeInstanceDestination =
      new google.computeInstance.ComputeInstance(this, "destination", {
        bootDisk: {
          initializeParams: {
            image: cdktf.Token.asString(dataGoogleComputeImageDebian9.id),
          },
        },
        ...
        networkInterface: [
          {
            accessConfig: [{}],
            network: cdktf.Token.asString(googleComputeNetworkVpc.id),
          },
        ],
      });
    const googleComputeInstanceSource =
      new google.computeInstance.ComputeInstance(this, "source", {
        bootDisk: {
          initializeParams: {
            image: cdktf.Token.asString(dataGoogleComputeImageDebian9.id),
          },
    ...
    new google.networkManagementConnectivityTest.NetworkManagementConnectivityTest(
      ...
      {
        destination: {
          instance: cdktf.Token.asString(googleComputeInstanceDestination.id),
        },
        name: "conn-test-instances",
        protocol: "TCP",
        source: {
          instance: cdktf.Token.asString(googleComputeInstanceSource.id),
        },
      }
    );
  }
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleComputeAddressDestAddr =
      new google.computeAddress.ComputeAddress(this, "dest-addr", {
        address: "10.0.43.43",
        addressType: "INTERNAL",
        name: "dest-addr",
        region: "us-central1",
        subnetwork: cdktf.Token.asString(googleComputeSubnetworkSubnet.id),
      });
    const googleComputeAddressSourceAddr =
      new google.computeAddress.ComputeAddress(this, "source-addr", {
        address: "10.0.42.42",
        addressType: "INTERNAL",
        name: "src-addr",
        region: "us-central1",
    ...
    new google.networkManagementConnectivityTest.NetworkManagementConnectivityTest(
      ...
      {
        destination: {
          ipAddress: cdktf.Token.asString(googleComputeAddressDestAddr.address),
          network: cdktf.Token.asString(googleComputeNetworkVpc.id),
          projectId: cdktf.Token.asString(googleComputeAddressDestAddr.project),
        },
        name: "conn-test-addr",
        protocol: "UDP",
        source: {
          ipAddress: cdktf.Token.asString(
            googleComputeAddressSourceAddr.address
          ),
          network: cdktf.Token.asString(googleComputeNetworkVpc.id),
          networkType: "GCP_NETWORK",
          projectId: cdktf.Token.asString(
            googleComputeAddressSourceAddr.project
          ),
        },
      }
    );
...
* `networkType` -
  ...
  Possible values are: `gcpNetwork`, `nonGcpNetwork`.
