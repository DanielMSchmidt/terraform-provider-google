...
* `id` - an identifier for the resource with format `{{parent}}/locations/{{location}}/buckets/{{bucket}}/links/{{linkId}}`
...
<a name="nested_bigquery_dataset"></a>The `bigqueryDataset` block contains:
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-cb2026dd870c8c3fc55ab65001dc4a3b5b14ff1e3bde9ea593a88af1fcc9d133 -->