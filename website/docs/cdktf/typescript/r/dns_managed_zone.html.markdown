...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.dnsManagedZone.DnsManagedZone(this, "example-zone", {
      ...
      dnsName: "example-${" + randomIdRnd.hex + "}.com.",
      labels: {
        foo: "bar",
      },
      name: "example-zone",
  ...
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.dnsManagedZone.DnsManagedZone(this, "private-zone", {
      ...
      privateVisibilityConfig: {
        networks: [
          {
            networkUrl: cdktf.Token.asString(googleComputeNetworkNetwork1.id),
          },
          {
            networkUrl: cdktf.Token.asString(googleComputeNetworkNetwork2.id),
          },
        ],
      },
      visibility: "private",
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.dnsManagedZone.DnsManagedZone(this, "peering-zone", {
      ...
      peeringConfig: {
        targetNetwork: {
          networkUrl: cdktf.Token.asString(
            googleComputeNetworkNetworkTarget.id
          ),
        },
      },
      privateVisibilityConfig: {
        networks: [
          {
            networkUrl: cdktf.Token.asString(
              googleComputeNetworkNetworkSource.id
            ),
          },
        ],
      },
