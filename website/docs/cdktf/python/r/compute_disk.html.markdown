...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_disk.ComputeDisk(self, "default",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_compute_disk_primary = google.compute_disk.ComputeDisk(self, "primary",
        ...
        google.compute_disk.ComputeDisk(self, "secondary",
            async_primary_disk=[{
                "disk": google_compute_disk_primary.id
            }
            ],
