...
* `kmsKeySelfLink` - (Optional) The self_link of the encryption key that is
...
-> **Note:** The `desiredStatus` field will not be set on import. If you have it set, Terraform will update the field on the next `terraform apply`, bringing your instance to the desired status.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-981f710708db7481ed76202d4ee4b45920b0d77e77babae7cb515f0e3c1e1492 -->