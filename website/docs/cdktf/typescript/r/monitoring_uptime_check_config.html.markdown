...
values will be stored in the raw state as plain text: `httpCheckAuthInfoPassword`.
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    const googleMonitoringGroupCheck =
      new google.monitoringGroup.MonitoringGroup(this, "check", {
    ...
    new google.monitoringUptimeCheckConfig.MonitoringUptimeCheckConfig(
      ...
      "tcp_group",
      {
        ...
        resourceGroup: {
          groupId: cdktf.Token.asString(googleMonitoringGroupCheck.name),
...
* `checkerType` -
  ...
  Possible values are: `staticIpCheckers`, `vpcCheckers`.
...
* `matcher` -
  ...
  Possible values are: `containsString`, `notContainsString`, `matchesRegex`, `notMatchesRegex`, `matchesJsonPath`, `notMatchesJsonPath`.
...
* `jsonMatcher` -
  ...
  Possible values are: `exactMatch`, `regexMatch`.
...
* `requestMethod` -
  ...
  Possible values are: `methodUnspecified`, `get`, `post`.

* `contentType` -
  (Optional)
  The content type to use for the check.
  Possible values are: `typeUnspecified`, `urlEncoded`.
...
<a name="nested_auth_info"></a>The `authInfo` block supports:
...
* `statusClass` -
  ...
  Possible values are: `statusClass1Xx`, `statusClass2Xx`, `statusClass3Xx`, `statusClass4Xx`, `statusClass5Xx`, `statusClassAny`.
...
* `resourceType` -
  ...
  Possible values are: `resourceTypeUnspecified`, `instance`, `awsElbLoadBalancer`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-6af5c3cfa6632a15d12ee9bd9d17ac5a057168abe01e8958b4bcab13aab179ab -->