...
**Note:** When using `googleComputeAttachedDisk` you **must** use `lifecycle.ignore_changes = ["attached_disk"]` on the `googleComputeInstance` resource that has the disks attached. Otherwise the two resources will fight for control of the attached disk block.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-869aca0b303a754f5b20d554706bdc87ffdb60f9453d2bfd5d57a25945ac58ce -->