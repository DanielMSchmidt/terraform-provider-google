...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_storage_bucket_image_bucket =
        google.storage_bucket.StorageBucket(self, "image_bucket",
            location="EU",
            name="image-store-bucket"
        )
        google.compute_backend_bucket.ComputeBackendBucket(self, "image_backend",
            bucket_name=cdktf.Token.as_string(google_storage_bucket_image_bucket.name),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e558df70a2bbb64e8267c4d8f77da722edb6d6f39d32382ce7768be33e110cb6 -->