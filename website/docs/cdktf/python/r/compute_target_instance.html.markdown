...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_google_compute_image_vmimage =
        google.data_google_compute_image.DataGoogleComputeImage(self, "vmimage",
            family="debian-11",
            project="debian-cloud"
        )
        google_compute_instance_target_vm =
        google.compute_instance.ComputeInstance(self, "target-vm",
            boot_disk=ComputeInstanceBootDisk(
                initialize_params=ComputeInstanceBootDiskInitializeParams(
                    image=cdktf.Token.as_string(data_google_compute_image_vmimage.self_link)
                )
            ),
        ...
        google.compute_target_instance.ComputeTargetInstance(self, "default",
            instance=cdktf.Token.as_string(google_compute_instance_target_vm.id),
            name="target"
        )
```
<div class = "oics-button" style="float: right; margin: 0 0 -15px">
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_google_compute_network_target_vm =
        google.data_google_compute_network.DataGoogleComputeNetwork(self, "target-vm",
            name="default",
            provider=google_beta
        )
        google_compute_instance_target_vm =
        google.compute_instance.ComputeInstance(self, "target-vm_2",
            boot_disk=ComputeInstanceBootDisk(
                initialize_params=ComputeInstanceBootDiskInitializeParams(
                    image=cdktf.Token.as_string(data_google_compute_image_vmimage.self_link)
                )
        ...
        google_compute_instance_target_vm.override_logical_id("target-vm")
        google.compute_target_instance.ComputeTargetInstance(self, "custom_network",
            instance=cdktf.Token.as_string(google_compute_instance_target_vm.id),
            name="custom-network",
            network=data_google_compute_network_target_vm.self_link,
            provider=google_beta
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-afd499ef562f68671daf70ff7469e99ea8df041b9a83705b11cb81ba08aa3230 -->