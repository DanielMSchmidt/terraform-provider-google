...
values will be stored in the raw state as plain text: `diskEncryptionKeyRawKey`, `diskEncryptionKeyRsaEncryptedKey`.
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    const googleComputeDiskPrimary = new google.computeDisk.ComputeDisk(
      this,
      "primary",
      {
    ...
    new google.computeDisk.ComputeDisk(this, "secondary", {
      async_primary_disk: [
        {
          disk: googleComputeDiskPrimary.id,
        },
      ],
...
<a name="nested_async_primary_disk"></a>The `asyncPrimaryDisk` block supports:
...
* `type` -
  ...
  Possible values are: `multiIpSubnet`, `secureBoot`, `sevCapable`, `uefiCompatible`, `virtioScsiMultiqueue`, `windows`, `gvnic`, `sevLiveMigratable`, `sevSnpCapable`, `suspendResumeCompatible`, `tdxCapable`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-d4777dbb9135593343df13e33ae0580ed3c74c28b620ab4346d94dac762e712b -->