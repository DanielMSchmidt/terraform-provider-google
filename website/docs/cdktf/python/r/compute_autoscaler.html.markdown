...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_target_pool_foobar =
        google.compute_target_pool.ComputeTargetPool(self, "foobar",
            name="my-target-pool"
        )
        ...
        google_compute_instance_template_foobar =
        google.compute_instance_template.ComputeInstanceTemplate(self, "foobar_2",
            can_ip_forward=False,
            disk=[ComputeInstanceTemplateDisk(
                source_image=cdktf.Token.as_string(data_google_compute_image_debian9.id)
            )
            ],
            machine_type="e2-medium",
            metadata={
        ...
        google_compute_instance_template_foobar.override_logical_id("foobar")
        google_compute_instance_group_manager_foobar =
        google.compute_instance_group_manager.ComputeInstanceGroupManager(self, "foobar_3",
            base_instance_name="foobar",
            name="my-igm",
            target_pools=[cdktf.Token.as_string(google_compute_target_pool_foobar.id)],
            version=[ComputeInstanceGroupManagerVersion(
                instance_template=cdktf.Token.as_string(google_compute_instance_template_foobar.id),
                name="primary"
            )
            ],
            zone="us-central1-f"
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_compute_instance_group_manager_foobar.override_logical_id("foobar")
        google_compute_autoscaler_foobar =
        google.compute_autoscaler.ComputeAutoscaler(self, "foobar_4",
            ...
            name="my-autoscaler",
            target=cdktf.Token.as_string(google_compute_instance_group_manager_foobar.id),
            zone="us-central1-f"
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_compute_autoscaler_foobar.override_logical_id("foobar")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-82fcd6111da4130f2dcbefcc3f292dd8f994dcffd3440050b3b959eee772100e -->