...
* `modelType` -
  ...
  * MODEL_TYPE_ADVANCED: Use advanced NLU model.
  Possible values are: `modelTypeStandard`, `modelTypeAdvanced`.
...
* `modelTrainingMode` -
  ...
  * MODEL_TRAINING_MODE_MANUAL: User needs to manually trigger NLU model training. Best for large flows whose models take long time to train.
  Possible values are: `modelTrainingModeAutomatic`, `modelTrainingModeManual`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-3a6fc4a761d2d022686fc7f580d581b3086de7459c4ed4e41e4c70d7f9fc8cc7 -->