...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.dataprocClusterIamPolicy.DataprocClusterIamPolicy(
      this,
      "editor",
      {
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.dataprocClusterIamBinding.DataprocClusterIamBinding(
      this,
      "editor",
      {
        cluster: "your-dataproc-cluster",
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.dataprocClusterIamMember.DataprocClusterIamMember(
      this,
      "editor",
      {
        cluster: "your-dataproc-cluster",
