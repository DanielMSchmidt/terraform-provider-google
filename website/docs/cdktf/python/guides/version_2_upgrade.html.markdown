...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.cloudbuild_trigger.CloudbuildTrigger(self, "build_trigger",
            build_attribute=CloudbuildTriggerBuild(
                images=["gcr.io/$PROJECT_ID/$REPO_NAME:$SHORT_SHA"],
                step=[CloudbuildTriggerBuildStep(
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_disk.ComputeDisk(self, "foobar",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_disk_my_disk = google.compute_disk.ComputeDisk(self, "my_disk",
            image=cdktf.Token.as_string(data_google_compute_image_my_image.self_link),
            name="my-disk",
            size=10,
            type="pd-ssd",
        ...
        google.compute_snapshot.ComputeSnapshot(self, "my_snapshot",
            name="my-snapshot",
            snapshot_encryption_key=ComputeSnapshotSnapshotEncryptionKey(
                raw_key="SGVsbG8gZnJvbSBHb29nbGUgQ2xvdWQgUGxhdGZvcm0="
            ),
            source_disk=cdktf.Token.as_string(google_compute_disk_my_disk.name),
            zone="us-central1-a"
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-adf2fb4517a9bd0fc8b2fb7dcf10ee1c5ee012dc3421afe240631f459ac42221 -->