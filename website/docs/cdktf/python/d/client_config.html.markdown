...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        cdktf.TerraformOutput(self, "project",
            value=data_google_client_config_current.project
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-6604545bde9c5512cc286dc869ab181a9078db4c5b11c9fc4fdd234a012af82d -->