...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_storage_bucket_static = google.storage_bucket.StorageBucket(self, "static",
            location="US",
            name="static-asset-bucket"
        )
        google_compute_backend_bucket_static =
        google.compute_backend_bucket.ComputeBackendBucket(self, "static_2",
            bucket_name=cdktf.Token.as_string(google_storage_bucket_static.name),
            enable_cdn=True,
            name="static-asset-backend-bucket"
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_compute_backend_bucket_static.override_logical_id("static")
        google_compute_backend_service_login =
        google.compute_backend_service.ComputeBackendService(self, "login",
            health_checks=[
        ...
        google.compute_url_map.ComputeUrlMap(self, "urlmap",
            default_service=cdktf.Token.as_string(google_compute_backend_bucket_static.id),
            ...
            path_matcher=[ComputeUrlMapPathMatcher(
                ...
                path_rule=[ComputeUrlMapPathMatcherPathRule(
                    paths=["/home"],
                    service=cdktf.Token.as_string(google_compute_backend_bucket_static.id)
                ), ComputeUrlMapPathMatcherPathRule(
                    paths=["/login"],
                    service=cdktf.Token.as_string(google_compute_backend_service_login.id)
                ), ComputeUrlMapPathMatcherPathRule(
                    paths=["/static"],
                    service=cdktf.Token.as_string(google_compute_backend_bucket_static.id)
                )
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_backend_service_home =
        google.compute_backend_service.ComputeBackendService(self, "home",
            health_checks=[
        ...
        google.compute_url_map.ComputeUrlMap(self, "urlmap",
            default_service=cdktf.Token.as_string(google_compute_backend_service_home.id),
            description="a description",
            host_rule=[ComputeUrlMapHostRule(
                hosts=["mysite.com"],
            ...
            path_matcher=[ComputeUrlMapPathMatcher(
                default_service=cdktf.Token.as_string(google_compute_backend_service_home.id),
                name="allpaths",
                route_rules=[ComputeUrlMapPathMatcherRouteRules(
                    header_action=ComputeUrlMapPathMatcherRouteRulesHeaderAction(
                        request_headers_to_add=[ComputeUrlMapPathMatcherRouteRulesHeaderActionRequestHeadersToAdd(
                        ...
                        response_headers_to_add=[ComputeUrlMapPathMatcherRouteRulesHeaderActionResponseHeadersToAdd(
                            header_name="AddMe",
                    ...
                    match_rules=[ComputeUrlMapPathMatcherRouteRulesMatchRules(
                        full_path_match="a full path",
                        header_matches=[ComputeUrlMapPathMatcherRouteRulesMatchRulesHeaderMatches(
                        ...
                        ignore_case=True,
                        metadata_filters=[ComputeUrlMapPathMatcherRouteRulesMatchRulesMetadataFilters(
                            filter_labels=[ComputeUrlMapPathMatcherRouteRulesMatchRulesMetadataFiltersFilterLabels(
                                name="PLANET",
                                value="MARS"
                            )
                            ],
                        ...
                        query_parameter_matches=[ComputeUrlMapPathMatcherRouteRulesMatchRulesQueryParameterMatches(
                    ...
                    priority=1,
                    url_redirect=ComputeUrlMapPathMatcherRouteRulesUrlRedirect(
            ...
            test=[ComputeUrlMapTest(
                host="hi.com",
                path="/home",
                service=cdktf.Token.as_string(google_compute_backend_service_home.id)
            )
            ]
        )
```
    ...
    def __init__(self, scope, name):
        ...
        google.compute_url_map.ComputeUrlMap(self, "urlmap",
            ...
            path_matcher=[ComputeUrlMapPathMatcher(
                ...
                path_rule=[ComputeUrlMapPathMatcherPathRule(
                    paths=["/home"],
                    route_action=ComputeUrlMapPathMatcherPathRuleRouteAction(
                        cors_policy=ComputeUrlMapPathMatcherPathRuleRouteActionCorsPolicy(
                        ...
                        fault_injection_policy=ComputeUrlMapPathMatcherPathRuleRouteActionFaultInjectionPolicy(
                            abort=ComputeUrlMapPathMatcherPathRuleRouteActionFaultInjectionPolicyAbort(
                                http_status=234,
                                percentage=5.6
                            ),
                            delay=ComputeUrlMapPathMatcherPathRuleRouteActionFaultInjectionPolicyDelay(
                                fixed_delay=ComputeUrlMapPathMatcherPathRuleRouteActionFaultInjectionPolicyDelayFixedDelay(
                                    nanos=50000,
                                    seconds=cdktf.Token.as_string(0)
                                ),
                                percentage=7.8
                            )
                        ),
                        request_mirror_policy=ComputeUrlMapPathMatcherPathRuleRouteActionRequestMirrorPolicy(
                            backend_service=cdktf.Token.as_string(google_compute_backend_service_home.id)
                        ),
                        retry_policy=ComputeUrlMapPathMatcherPathRuleRouteActionRetryPolicy(
                            num_retries=4,
                            per_try_timeout=ComputeUrlMapPathMatcherPathRuleRouteActionRetryPolicyPerTryTimeout(
                                seconds=cdktf.Token.as_string(30)
                            ),
                            retry_conditions=["5xx", "deadline-exceeded"]
                        ),
                        timeout=ComputeUrlMapPathMatcherPathRuleRouteActionTimeout(
                            nanos=750000000,
                            seconds=cdktf.Token.as_string(20)
                        ),
                        url_rewrite=ComputeUrlMapPathMatcherPathRuleRouteActionUrlRewrite(
                            host_rewrite="dev.example.com",
                            path_prefix_rewrite="/v1/api/"
                        ),
                        weighted_backend_services=[ComputeUrlMapPathMatcherPathRuleRouteActionWeightedBackendServices(
                            backend_service=cdktf.Token.as_string(google_compute_backend_service_home.id),
                            header_action=ComputeUrlMapPathMatcherPathRuleRouteActionWeightedBackendServicesHeaderAction(
                                request_headers_to_add=[ComputeUrlMapPathMatcherPathRuleRouteActionWeightedBackendServicesHeaderActionRequestHeadersToAdd(
                                    header_name="AddMe",
                                    header_value="MyValue",
                                    replace=True
                                )
                                ...
                                response_headers_to_add=[ComputeUrlMapPathMatcherPathRuleRouteActionWeightedBackendServicesHeaderActionResponseHeadersToAdd(
                                    header_name="AddMe",
                                    header_value="MyValue",
                                    replace=False
                                )
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_backend_service_service_a =
        google.compute_backend_service.ComputeBackendService(self, "service-a",
            health_checks=[
                cdktf.Token.as_string(google_compute_http_health_check_default.id)
            ],
            name="service-a",
        ...
        google_compute_backend_service_service_b =
        google.compute_backend_service.ComputeBackendService(self, "service-b",
            health_checks=[
                cdktf.Token.as_string(google_compute_http_health_check_default.id)
            ],
            name="service-b",
        ...
        google.compute_url_map.ComputeUrlMap(self, "urlmap",
            ...
            path_matcher=[ComputeUrlMapPathMatcher(
                ...
                route_rules=[ComputeUrlMapPathMatcherRouteRules(
                    ...
                    priority=1,
                    service=cdktf.Token.as_string(google_compute_backend_service_service_a.id)
                    ...
                    priority=2,
                    service=cdktf.Token.as_string(google_compute_backend_service_service_b.id)
                )
                ]
            )
            ]
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-37a6e462ca28bb10565b393fcd3a6cf7d81d3ffc6efc90cf5b6257d0f6d379db -->