...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_secret_manager_secret_secret_basic =
        google.secret_manager_secret.SecretManagerSecret(self, "secret-basic",
            labels={
                "label": "my-label"
            },
        ...
        google.secret_manager_secret_version.SecretManagerSecretVersion(self, "secret-version-basic",
            secret=cdktf.Token.as_string(google_secret_manager_secret_secret_basic.id),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-5506c71bba1e6ca243de7f4168040c302ebdcad6a5a5958f66c7d6bc6fb7eb13 -->