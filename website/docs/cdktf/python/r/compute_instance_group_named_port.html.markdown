...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_container_cluster_my_cluster =
        google.container_cluster.ContainerCluster(self, "my_cluster",
        ...
        google.compute_instance_group_named_port.ComputeInstanceGroupNamedPortA(self, "my_port",
            group=cdktf.Token.as_string(
                cdktf.property_access(google_container_cluster_my_cluster.node_pool, ["0", "instance_group_urls", "0"
                ])),
            name="http",
            port=8080,
            zone="us-central1-a"
        )
        google.compute_instance_group_named_port.ComputeInstanceGroupNamedPortA(self, "my_ports",
            group=cdktf.Token.as_string(
                cdktf.property_access(google_container_cluster_my_cluster.node_pool, ["0", "instance_group_urls", "0"
                ])),
            name="https",
