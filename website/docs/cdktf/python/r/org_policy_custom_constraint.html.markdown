...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.OrgPolicyCustomConstraint(self, "constraint",
            action_type="ALLOW",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_org_policy_custom_constraint_constraint =
        google.OrgPolicyCustomConstraint(self, "constraint",
            action_type="ALLOW",
            condition="resource.management.autoUpgrade == false",
        ...
        google.OrgPolicyPolicy(self, "bool",
            name="organizations/123456789/policies/${" + google_org_policy_custom_constraint_constraint.name + "}",
            parent="organizations/123456789",
            provider=google_beta,
            spec=[{
                "rules": [{
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-6877a3040ab6e9db3eab7d54989c99f210c9b031d183002a32081c67d479c69f -->