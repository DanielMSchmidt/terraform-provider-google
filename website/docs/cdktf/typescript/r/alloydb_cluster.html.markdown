...
values will be stored in the raw state as plain text: `initialUserPassword`.
...
<a name="nested_encryption_info"></a>The `encryptionInfo` block contains:
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-9ce9bad9f5de8502ceb1c83df2d3bfe9deda09891742970e658ae4f44801dd9a -->