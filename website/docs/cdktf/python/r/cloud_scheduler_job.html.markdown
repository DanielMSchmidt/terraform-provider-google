...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.cloud_scheduler_job.CloudSchedulerJob(self, "job",
            description="test job",
            name="test-job",
            pubsub_target=CloudSchedulerJobPubsubTarget(
                data=cdktf.Fn.base64encode("test"),
                topic_name=cdktf.Token.as_string(google_pubsub_topic_topic.id)
            ),
            schedule="*/2 * * * *"
        )
```
    ...
    def __init__(self, scope, name):
        ...
        google.cloud_scheduler_job.CloudSchedulerJob(self, "job",
            ...
            http_target=CloudSchedulerJobHttpTarget(
                body=cdktf.Fn.base64encode("{\\\"foo\\\":\\\"bar\\\"}"),
                http_method="POST",
        ...
        google.cloud_scheduler_job.CloudSchedulerJob(self, "job",
            ...
            http_target=CloudSchedulerJobHttpTarget(
                ...
                oauth_token=CloudSchedulerJobHttpTargetOauthToken(
                    service_account_email=cdktf.Token.as_string(data_google_compute_default_service_account_default.email)
                ),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-c505add819f2efde15b6cad8065526fa2310d6ea3784685514c8955c764acfde -->