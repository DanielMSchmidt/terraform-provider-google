...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.dataproc_job_iam_policy.DataprocJobIamPolicy(self, "editor",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.dataproc_job_iam_binding.DataprocJobIamBinding(self, "editor",
            job_id="your-dataproc-job",
            members=["user:jane@example.com"],
            role="roles/editor"
        )
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.dataproc_job_iam_member.DataprocJobIamMember(self, "editor",
            job_id="your-dataproc-job",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-692a9d2c42057ebba3e5383c16ec642a77e3a38a55e4aebf83c7e24d4eec609e -->