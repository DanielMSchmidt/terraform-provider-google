...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_google_compute_image_debian =
        google.data_google_compute_image.DataGoogleComputeImage(self, "debian",
            family="debian-11",
            project="debian-cloud"
        )
        google_compute_disk_persistent = google.compute_disk.ComputeDisk(self, "persistent",
            image=cdktf.Token.as_string(data_google_compute_image_debian.self_link),
            name="debian-disk",
            size=10,
            type="pd-ssd",
            zone="us-central1-a"
        )
        google.compute_snapshot.ComputeSnapshot(self, "snapshot",
            labels={
                "my_label": "value"
            },
            name="my-snapshot",
            source_disk=cdktf.Token.as_string(google_compute_disk_persistent.id),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e04dd2d4af2f03d9831cf3546dead965cc76006e7670243cf298719088c23753 -->