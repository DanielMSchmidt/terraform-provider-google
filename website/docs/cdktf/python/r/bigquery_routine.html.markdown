...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_bigquery_dataset_test =
        google.bigquery_dataset.BigqueryDataset(self, "test",
            dataset_id="dataset_id"
        )
        google.bigquery_routine.BigqueryRoutine(self, "sproc",
            dataset_id=cdktf.Token.as_string(google_bigquery_dataset_test.dataset_id),
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.bigquery_routine.BigqueryRoutine(self, "sproc",
            arguments=[BigqueryRoutineArguments(
