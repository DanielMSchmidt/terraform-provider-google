...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.identity_platform_oauth_idp_config.IdentityPlatformOauthIdpConfig(self, "oauth_idp_config",
            client_id="client-id",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-91256586b3c8316a0775472d100c5564997dbc2d976f8127bfa1f989f330df41 -->