...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.project_iam_policy.ProjectIamPolicy(self, "project",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.project_iam_binding.ProjectIamBinding(self, "project",
            members=["user:jane@example.com"],
            project="your-project-id",
            role="roles/editor"
        )
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.project_iam_member.ProjectIamMember(self, "project",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.project_iam_audit_config.ProjectIamAuditConfig(self, "project",
            audit_log_config=[ProjectIamAuditConfigAuditLogConfig(
                log_type="ADMIN_READ"
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-75cbfa26c0814d2731447b46624650751b617a75e62bbccfd5532557c8d5eb8b -->