...
values will be stored in the raw state as plain text: `selfManagedCertificatePem`, `selfManagedPrivateKeyPem`, `selfManagedPemPrivateKey`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-046e041bced2fc034cf12f39443bfb56dab151f97b2c0acaacc5923335e8dfb5 -->