...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_cloudbuildv2_connection_my_connection =
        google.Cloudbuildv2Connection(self, "my-connection",
            github_config=[{
        ...
        google_cloudbuildv2_repository_my_repository =
        google.Cloudbuildv2Repository(self, "my-repository",
            name="my-repo",
            parent_connection=google_cloudbuildv2_connection_my_connection.id,
            provider=google_beta,
            remote_uri="https://github.com/myuser/my-repo.git"
        )
        google.cloudbuild_trigger.CloudbuildTrigger(self, "repo-trigger",
            filename="cloudbuild.yaml",
            location="us-central1",
            provider=google_beta,
            repository_event_config=[{
                ...
                "repository": google_cloudbuildv2_repository_my_repository.id
            }
            ]
        )
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_pubsub_topic_mytopic = google.pubsub_topic.PubsubTopic(self, "mytopic",
            name="mytopic",
            provider=google_beta
        )
        google.cloudbuild_trigger.CloudbuildTrigger(self, "pubsub-with-repo-trigger",
            git_file_source=[{
                "path": "cloudbuild.yaml",
                "repo_type": "GITHUB",
                "repository": google_cloudbuildv2_repository_my_repository.id,
            ...
            provider=google_beta,
            pubsub_config=[{
                "topic": google_pubsub_topic_mytopic.id
            }
            ],
            source_to_build=[{
                "ref": "refs/heads/main",
