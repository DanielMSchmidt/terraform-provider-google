...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.ServiceUsageConsumerQuotaOverride(self, "override",
            force=True,
            limit=cdktf.Fn.urlencode("/min/project"),
            metric=cdktf.Fn.urlencode("servicemanagement.googleapis.com/default_requests"),
            override_value="95",
            project=google_project_my_project.project_id,
            provider=google_beta,
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.ServiceUsageConsumerQuotaOverride(self, "override",
            ...
            force=True,
            limit=cdktf.Fn.urlencode("/project/region"),
            metric=cdktf.Fn.urlencode("compute.googleapis.com/n2_cpus"),
            override_value="8",
            project=google_project_my_project.project_id,
            provider=google_beta,
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.ServiceUsageConsumerQuotaOverride(self, "override",
            ...
            force=True,
            limit=cdktf.Fn.urlencode("/author/project"),
            metric=cdktf.Fn.urlencode("libraryagent.googleapis.com/borrows"),
            override_value="1",
            project=google_project_my_project.project_id,
            provider=google_beta,
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-10bcd6d32a414440727579a9c5724d322f0d4cec8188372f8891def6c4d7074b -->