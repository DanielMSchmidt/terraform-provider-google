...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.NetworkServicesHttpRoute(self, "default",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_network_services_mesh_default = google.NetworkServicesMesh(self, "default",
            description="my description",
            labels=[{
                "foo": "bar"
            }
        ...
        google_network_services_http_route_default =
        google.NetworkServicesHttpRoute(self, "default_1",
            description="my description",
            hostnames=["example"],
            labels=[{
                "foo": "bar"
        ...
        google_network_services_http_route_default.override_logical_id("default")
```
