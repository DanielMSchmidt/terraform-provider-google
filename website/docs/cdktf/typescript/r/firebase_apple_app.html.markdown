...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.FirebaseAppleApp(this, "default", {
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.FirebaseAppleApp(this, "full", {
      app_store_id: "12345",
      bundle_id: "apple.app.12345",
...
* `id` - an identifier for the resource with format `projects/{{project}}/iosApps/{{appId}}`
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-dc1814fe28ab198e58bf632a461efd11b6f53df6cab112670bdf4f1d1681510c -->