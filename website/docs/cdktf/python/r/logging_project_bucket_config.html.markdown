...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.logging_project_bucket_config.LoggingProjectBucketConfig(self, "basic",
            bucket_id="_Default",
            location="global",
            project=cdktf.Token.as_string(google_project_default.project_id),
            retention_days=30
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-274c5e16b2262c0e0d5421cfc7a255933047653a4a5a655ef9d4bb8da9f37861 -->