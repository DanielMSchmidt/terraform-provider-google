...
* `mode` -
  ...
  Possible values are: `standardRepository`, `virtualRepository`, `remoteRepository`.
...
<a name="nested_docker_config"></a>The `dockerConfig` block supports:
...
* `versionPolicy` -
  ...
  Possible values are: `versionPolicyUnspecified`, `release`, `snapshot`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-bb7665291f55585ef2a4cd9f68654d21811254c07876fcce697e8887668226e8 -->