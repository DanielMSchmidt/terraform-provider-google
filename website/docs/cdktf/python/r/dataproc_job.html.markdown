...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_dataproc_cluster_mycluster =
        google.dataproc_cluster.DataprocCluster(self, "mycluster",
            name="dproc-cluster-unique-name",
            region="us-central1"
        )
        google_dataproc_job_pyspark = google.dataproc_job.DataprocJob(self, "pyspark",
            force_delete=True,
            placement=DataprocJobPlacement(
                cluster_name=cdktf.Token.as_string(google_dataproc_cluster_mycluster.name)
            ),
            ...
            region=cdktf.Token.as_string(google_dataproc_cluster_mycluster.region)
        )
        google_dataproc_job_spark = google.dataproc_job.DataprocJob(self, "spark",
            force_delete=True,
            placement=DataprocJobPlacement(
                cluster_name=cdktf.Token.as_string(google_dataproc_cluster_mycluster.name)
            ),
        ...
        cdktf.TerraformOutput(self, "pyspark_status",
            value=cdktf.property_access(google_dataproc_job_pyspark.status, ["0", "state"
            ])
        )
        cdktf.TerraformOutput(self, "spark_status",
            value=cdktf.property_access(google_dataproc_job_spark.status, ["0", "state"
            ])
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-b9eff6e0428dcd4ba2d0af5d6a9f6242e3b451562e8c658317210ce25daf149d -->