...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
      ...
      new google.cloudfunctionsFunction.CloudfunctionsFunction(
        ...
        "function",
        {
          ...
          sourceArchiveObject: cdktf.Token.asString(
            googleStorageBucketObjectArchive.name
          ),
          triggerHttp: true,
        }
      );
    new google.cloudfunctionsFunctionIamMember.CloudfunctionsFunctionIamMember(
      ...
      "invoker",
      {
        cloudFunction: cdktf.Token.asString(
          googleCloudfunctionsFunctionFunction.name
        ),
        member: "allUsers",
        project: cdktf.Token.asString(
          googleCloudfunctionsFunctionFunction.project
        ),
        region: cdktf.Token.asString(
          googleCloudfunctionsFunctionFunction.region
        ),
