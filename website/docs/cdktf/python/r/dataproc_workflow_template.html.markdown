...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.dataproc_workflow_template.DataprocWorkflowTemplate(self, "template",
            jobs=[DataprocWorkflowTemplateJobs(
                spark_job=DataprocWorkflowTemplateJobsSparkJob(
                    main_class="SomeClass"
                ),
                step_id="someJob"
            ), DataprocWorkflowTemplateJobs(
                prerequisite_step_ids=["someJob"],
                presto_job=DataprocWorkflowTemplateJobsPrestoJob(
            ...
            placement=DataprocWorkflowTemplatePlacement(
                managed_cluster=DataprocWorkflowTemplatePlacementManagedCluster(
                    cluster_name="my-cluster",
                    config=DataprocWorkflowTemplatePlacementManagedClusterConfig(
                        gce_cluster_config=DataprocWorkflowTemplatePlacementManagedClusterConfigGceClusterConfig(
                            tags=["foo", "bar"],
                            zone="us-central1-a"
                        ),
                        master_config=DataprocWorkflowTemplatePlacementManagedClusterConfigMasterConfig(
                            disk_config=DataprocWorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfig(
                        ...
                        secondary_worker_config=DataprocWorkflowTemplatePlacementManagedClusterConfigSecondaryWorkerConfig(
                            num_instances=2
                        ),
                        software_config=DataprocWorkflowTemplatePlacementManagedClusterConfigSoftwareConfig(
                            image_version="2.0.35-debian10"
                        ),
                        worker_config=DataprocWorkflowTemplatePlacementManagedClusterConfigWorkerConfig(
                            disk_config=DataprocWorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfig(
