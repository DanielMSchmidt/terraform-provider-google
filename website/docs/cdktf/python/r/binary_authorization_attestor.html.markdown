...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_container_analysis_note_note =
        google.container_analysis_note.ContainerAnalysisNote(self, "note",
        ...
        google.binary_authorization_attestor.BinaryAuthorizationAttestor(self, "attestor",
            attestation_authority_note=BinaryAuthorizationAttestorAttestationAuthorityNote(
                note_reference=cdktf.Token.as_string(google_container_analysis_note_note.name),
                public_keys=[BinaryAuthorizationAttestorAttestationAuthorityNotePublicKeys(
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_kms_crypto_key_crypto_key = google.kms_crypto_key.KmsCryptoKey(self, "crypto-key",
        ...
        data_google_kms_crypto_key_version_version =
        google.data_google_kms_crypto_key_version.DataGoogleKmsCryptoKeyVersion(self, "version",
            crypto_key=cdktf.Token.as_string(google_kms_crypto_key_crypto_key.id)
        )
        google.binary_authorization_attestor.BinaryAuthorizationAttestor(self, "attestor",
            attestation_authority_note=BinaryAuthorizationAttestorAttestationAuthorityNote(
                note_reference=cdktf.Token.as_string(google_container_analysis_note_note.name),
                public_keys=[BinaryAuthorizationAttestorAttestationAuthorityNotePublicKeys(
                    id=cdktf.Token.as_string(data_google_kms_crypto_key_version_version.id),
                    pkix_public_key=BinaryAuthorizationAttestorAttestationAuthorityNotePublicKeysPkixPublicKey(
                        public_key_pem=cdktf.Token.as_string(
                            cdktf.property_access(data_google_kms_crypto_key_version_version.public_key, ["0", "pem"])),
                        signature_algorithm=cdktf.Token.as_string(
                            cdktf.property_access(data_google_kms_crypto_key_version_version.public_key, ["0", "algorithm"]))
                    )
                )
                ]
            ),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e5cb8d0f1a4f3c1bb2befe0cc849bac4a6940b18a4fc8987d1cee4f450c7f922 -->