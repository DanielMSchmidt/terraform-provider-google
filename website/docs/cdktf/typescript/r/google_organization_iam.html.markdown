...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.organizationIamPolicy.OrganizationIamPolicy(
      this,
      "organization",
      {
        orgId: "1234567890",
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.organizationIamBinding.OrganizationIamBinding(
      this,
      "organization",
      {
        members: ["user:jane@example.com"],
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.organizationIamMember.OrganizationIamMember(
      this,
      "organization",
      {
...
* `orgId` - (Required) The organization id of the target organization.
