...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.NetworkSecurityAuthorizationPolicy(this, "default", {
      action: "ALLOW",
...
<a name="nested_http_header_match"></a>The `httpHeaderMatch` block supports:
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-640428686fa4690672189d2b179d27bdb58b052b7e24892a82ca176fb0d3904d -->