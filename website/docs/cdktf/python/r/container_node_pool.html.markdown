...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_container_cluster_primary =
        ...
        google.container_node_pool.ContainerNodePool(self, "primary_preemptible_nodes",
            cluster=cdktf.Token.as_string(google_container_cluster_primary.id),
            name="my-node-pool",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.container_cluster.ContainerCluster(self, "primary",
            ...
            node_config=ContainerClusterNodeConfig(
                guest_accelerator=[ContainerClusterNodeConfigGuestAccelerator(
                    count=1,
        ...
        google.container_node_pool.ContainerNodePool(self, "np",
            cluster=cdktf.Token.as_string(google_container_cluster_primary.id),
            name="my-node-pool",
            node_config=ContainerNodePoolNodeConfig(
                machine_type="e2-medium",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e885b59906a075703f71ee4a690837315181db85633b110b460b61c52213c8f7 -->