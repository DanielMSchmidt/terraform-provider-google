...
* `id` - an identifier for the resource with format `projects/{{project}}/locations/{{location}}/capacityCommitments/{{capacityCommitmentId}}`
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-24c7fa185ef306429c9a57620507a19e91472e2e63a78c5bf722dc3c43d243a8 -->