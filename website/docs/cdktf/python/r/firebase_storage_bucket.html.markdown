...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_storage_bucket_default = google.storage_bucket.StorageBucket(self, "default",
            location="US",
            name="test_bucket",
            provider=google_beta,
            uniform_bucket_level_access=True
        )
        google_firebase_storage_bucket_default = google.FirebaseStorageBucket(self, "default_1",
            bucket_id=google_storage_bucket_default.id,
            project="my-project-name",
            provider=google_beta
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_firebase_storage_bucket_default.override_logical_id("default")
```
