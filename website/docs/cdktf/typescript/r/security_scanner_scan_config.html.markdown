...
values will be stored in the raw state as plain text: `authenticationGoogleAccountPassword`, `authenticationCustomAccountPassword`.
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.SecurityScannerScanConfig(this, "scan-config", {
...
* `userAgent` -
  ...
  Possible values are: `userAgentUnspecified`, `chromeLinux`, `chromeAndroid`, `safariIphone`.
...
* `targetPlatforms` -
  ...
  Each value may be one of: `appEngine`, `compute`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-1002a3d1566c43827e381518e9bc717c3cc15f4886d91b36e4f4a1ec1157cacf -->