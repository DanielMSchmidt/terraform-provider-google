...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_health_check.ComputeHealthCheck(self, "tcp-health-check",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.compute_health_check.ComputeHealthCheck(self, "ssl-health-check",
            check_interval_sec=1,
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.compute_health_check.ComputeHealthCheck(self, "http-health-check",
            check_interval_sec=1,
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.compute_health_check.ComputeHealthCheck(self, "https-health-check",
            check_interval_sec=1,
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.compute_health_check.ComputeHealthCheck(self, "http2-health-check",
            check_interval_sec=1,
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.compute_health_check.ComputeHealthCheck(self, "grpc-health-check",
            check_interval_sec=1,
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.compute_health_check.ComputeHealthCheck(self, "health-check-with-logging",
            check_interval_sec=1,
            log_config=[{
                "enable": True
            }
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-322cfe19e87681c7641dc1c11c13aab46d43999df0e5dd16beaab955c1276d1f -->