...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.bigtable_app_profile.BigtableAppProfile(self, "ap",
            app_profile_id="bt-profile",
            ignore_warnings=True,
            instance=cdktf.Token.as_string(google_bigtable_instance_instance.name),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-c6fa5797cfcb1bb94a30084d86ab9191eada7269dcdc59961fb9a95245a29e1e -->