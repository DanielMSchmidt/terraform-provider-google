...
* `vpcConnectorEgressSettings` -
  ...
  Possible values are: `vpcConnectorEgressSettingsUnspecified`, `privateRangesOnly`, `allTraffic`.

* `ingressSettings` -
  (Optional)
  Available ingress settings. Defaults to "ALLOW_ALL" if unspecified.
  Default value is `allowAll`.
  Possible values are: `allowAll`, `allowInternalOnly`, `allowInternalAndGclb`.
...
* `retryPolicy` -
  ...
  Possible values are: `retryPolicyUnspecified`, `retryPolicyDoNotRetry`, `retryPolicyRetry`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-cc65bbbbf8773f0966463ea18d49ce1fc9fc005a34367869fd3152b7b6b9806a -->