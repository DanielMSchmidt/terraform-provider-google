...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_service_directory_service_example =
        google.ServiceDirectoryService(self, "example_1",
            namespace=google_service_directory_namespace_example.id,
            provider=google_beta,
            service_id="example-service"
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_service_directory_service_example.override_logical_id("example")
        google_service_directory_endpoint_example =
        google.ServiceDirectoryEndpoint(self, "example_2",
            address="1.2.3.4",
            ...
            port=5353,
            provider=google_beta,
            service=google_service_directory_service_example.id
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_service_directory_endpoint_example.override_logical_id("example")
```
<div class = "oics-button" style="float: right; margin: 0 0 -15px">
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_compute_network_example =
        google.compute_network.ComputeNetwork(self, "example",
            name="example-network",
            provider=google_beta
        )
        google_service_directory_namespace_example =
        google.ServiceDirectoryNamespace(self, "example_1",
            location="us-central1",
            namespace_id="example-namespace",
            provider=google_beta
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_service_directory_namespace_example.override_logical_id("example")
        google_service_directory_service_example =
        google.ServiceDirectoryService(self, "example_2",
            namespace=google_service_directory_namespace_example.id,
            provider=google_beta,
            service_id="example-service"
        )
        ...
        google_service_directory_endpoint_example =
        google.ServiceDirectoryEndpoint(self, "example_4",
            address="1.2.3.4",
            endpoint_id="example-endpoint",
            metadata=[{
                "region": "us-central1",
            ...
            network="projects/${" + data_google_project_project.number + "}/locations/global/networks/${" + google_compute_network_example.name + "}",
            port=5353,
            provider=google_beta,
            service=google_service_directory_service_example.id
        )
