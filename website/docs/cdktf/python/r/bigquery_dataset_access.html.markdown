...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_service_account_bqowner =
        google.service_account.ServiceAccount(self, "bqowner",
            account_id="bqowner"
        )
        google.bigquery_dataset_access.BigqueryDatasetAccessA(self, "access",
            dataset_id=cdktf.Token.as_string(google_bigquery_dataset_dataset.dataset_id),
            role="OWNER",
            user_by_email=cdktf.Token.as_string(google_service_account_bqowner.email)
        )
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_bigquery_dataset_private =
        google.bigquery_dataset.BigqueryDataset(self, "private",
            dataset_id="example_dataset"
        )
        google_bigquery_dataset_public =
        google.bigquery_dataset.BigqueryDataset(self, "public",
            dataset_id="example_dataset2"
        )
        google_bigquery_table_public = google.bigquery_table.BigqueryTable(self, "public_2",
            dataset_id=cdktf.Token.as_string(google_bigquery_dataset_public.dataset_id),
        ...
        google_bigquery_table_public.override_logical_id("public")
        google.bigquery_dataset_access.BigqueryDatasetAccessA(self, "access",
            dataset_id=cdktf.Token.as_string(google_bigquery_dataset_private.dataset_id),
            view=BigqueryDatasetAccessViewA(
                dataset_id=cdktf.Token.as_string(google_bigquery_dataset_public.dataset_id),
                project_id=cdktf.Token.as_string(google_bigquery_table_public.project),
                table_id=cdktf.Token.as_string(google_bigquery_table_public.table_id)
            )
        )
```
