  ...
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googlePubsubSubscriptionExample =
      new google.pubsubSubscription.PubsubSubscription(this, "example_1", {
        ...
        topic: cdktf.Token.asString(googlePubsubTopicExample.name),
      });
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googlePubsubTopicExampleDeadLetter =
      new google.pubsubTopic.PubsubTopic(this, "example_dead_letter", {
        name: "example-topic-dead-letter",
      });
    const googlePubsubSubscriptionExample =
      new google.pubsubSubscription.PubsubSubscription(this, "example_2", {
        deadLetterPolicy: {
          deadLetterTopic: cdktf.Token.asString(
            googlePubsubTopicExampleDeadLetter.id
          ),
