...
* `assetType` -
  ...
  Possible values are: `assetTypeDevice`, `assetTypeCredentialStrength`.
...
* `authorizationDirection` -
  ...
  Possible values are: `authorizationDirectionTo`, `authorizationDirectionFrom`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-25c11c7dd56b566dd7e31dac4b6f6367cfb97ed4272758f34ac6697f9f737ecb -->