...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_cloudiot_registry_registry =
        google.cloudiot_registry.CloudiotRegistry(self, "registry",
            name="cloudiot-device-registry"
        )
        google.cloudiot_device.CloudiotDevice(self, "test-device",
            name="cloudiot-device",
            registry=cdktf.Token.as_string(google_cloudiot_registry_registry.id)
        )
```
