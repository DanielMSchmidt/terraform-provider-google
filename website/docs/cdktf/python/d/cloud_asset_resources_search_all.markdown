...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.DataGoogleCloudAssetResourcesSearchAll(self, "projects",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.DataGoogleCloudAssetResourcesSearchAll(self, "cloud_build_projects",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.DataGoogleCloudAssetResourcesSearchAll(self, "project_service_accounts",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-0a6ab41310dc7e7145410bb12d6fb226f5cefd263685605cf2687bbebcf32a00 -->