...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_kms_crypto_key_key = google.kms_crypto_key.KmsCryptoKey(self, "key",
        ...
        google.kms_crypto_key_iam_policy.KmsCryptoKeyIamPolicy(self, "crypto_key",
            crypto_key_id=cdktf.Token.as_string(google_kms_crypto_key_key.id),
