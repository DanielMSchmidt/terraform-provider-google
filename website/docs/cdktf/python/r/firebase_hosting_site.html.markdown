...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.FirebaseHostingSite(self, "default",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_firebase_web_app_default = google.FirebaseWebApp(self, "default",
            deletion_policy="DELETE",
            display_name="Test web app for Firebase Hosting",
            project="my-project-name",
            provider=google_beta
        )
        google.FirebaseHostingSite(self, "full",
            app_id=google_firebase_web_app_default.app_id,
            project="my-project-name",
            provider=google_beta,
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-d9fa516e05222d865e255fefd75191fb7ab0824e89024c5e731498efa40d0a81 -->