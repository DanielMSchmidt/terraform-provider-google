...
values will be stored in the raw state as plain text: `cloudSqlCredentialPassword`.
...
* `type` -
  ...
  Possible values are: `databaseTypeUnspecified`, `postgres`, `mysql`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-6af5385c9d3bf642e6599ba0fe3c529e6ea2ede9866e5eab643225248195fc8a -->