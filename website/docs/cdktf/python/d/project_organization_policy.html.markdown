...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_google_project_organization_policy_policy =
        google.data_google_project_organization_policy.DataGoogleProjectOrganizationPolicy(self, "policy",
            constraint="constraints/serviceuser.services",
            project="project-id"
        )
        cdktf.TerraformOutput(self, "version",
            value=data_google_project_organization_policy_policy.version
        )
```
