...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.access_context_manager_service_perimeters.AccessContextManagerServicePerimeters(self, "service-perimeter",
            parent="accessPolicies/${" + google_access_context_manager_access_policy_access_policy.name + "}",
            service_perimeters=[AccessContextManagerServicePerimetersServicePerimeters(
                name="accessPolicies/${" + google_access_context_manager_access_policy_access_policy.name + "}/servicePerimeters/",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-050793f07538a7ca2464a925aa8d2eb5d56219514bc3de692bfdde9ccc24175c -->