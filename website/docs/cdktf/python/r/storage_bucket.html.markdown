...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.storage_bucket.StorageBucket(self, "static-site",
            cors=[StorageBucketCors(
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.storage_bucket.StorageBucket(self, "auto-expire",
            force_destroy=True,
            lifecycle_rule=[StorageBucketLifecycleRule(
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-267ddce0e88da45bae402ad5cabfbe29b8d16d510e7a8095b6dd791f80d01328 -->