...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.healthcare_fhir_store.HealthcareFhirStore(self, "default",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.healthcare_fhir_store.HealthcareFhirStore(self, "default",
            ...
            name="example-fhir-store",
            stream_configs=[HealthcareFhirStoreStreamConfigs(
                bigquery_destination=HealthcareFhirStoreStreamConfigsBigqueryDestination(
                    dataset_uri="bq://${" + google_bigquery_dataset_bq_dataset.project + "}.${" + google_bigquery_dataset_bq_dataset.dataset_id + "}",
        ...
        google.pubsub_topic.PubsubTopic(self, "topic",
            name="fhir-notifications"
        )
```
<div class = "oics-button" style="float: right; margin: 0 0 -15px">
    ...
    def __init__(self, scope, name):
        ...
        google.healthcare_fhir_store.HealthcareFhirStore(self, "default",
            ...
            notification_configs=[{
                "pubsub_topic": google_pubsub_topic_topic.id,
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-2383af7688c73b7c6f30751d6f4e33a9b11a2d2a786e81b474bdf22207d03bf9 -->