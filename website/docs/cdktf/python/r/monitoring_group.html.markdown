...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.monitoring_group.MonitoringGroup(self, "basic",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_monitoring_group_parent =
        google.monitoring_group.MonitoringGroup(self, "parent",
            display_name="tf-test MonitoringParentGroup",
            filter="resource.metadata.region=\\\"europe-west2\\\""
        )
        google.monitoring_group.MonitoringGroup(self, "subgroup",
            display_name="tf-test MonitoringSubGroup",
            filter="resource.metadata.region=\\\"europe-west2\\\"",
            parent_name=cdktf.Token.as_string(google_monitoring_group_parent.name)
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e461abda8bb1b1b82ee5ff439093ec8b6f0fa776b978ef3927104b19b57944b6 -->