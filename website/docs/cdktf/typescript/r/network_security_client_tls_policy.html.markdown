...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.NetworkSecurityClientTlsPolicy(this, "default", {
...
<a name="nested_client_certificate"></a>The `clientCertificate` block supports:
...
<a name="nested_server_validation_ca"></a>The `serverValidationCa` block supports:
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-9ed4697fd5ed5a11aa66577fa31f57a0e4a64e5a1d5e2e3b541af94d3f0d5d83 -->