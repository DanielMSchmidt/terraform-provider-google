...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleWorkstationsWorkstationClusterDefault =
      new google.WorkstationsWorkstationCluster(this, "default_2", {
        annotations: [
          {
            "label-one": "value-one",
          },
    ...
    const googleWorkstationsWorkstationConfigDefault =
      new google.WorkstationsWorkstationConfig(this, "default_3", {
        container: [
          {
            env: [
              {
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    const googleComputeDiskMySourceDisk = new google.computeDisk.ComputeDisk(
      this,
      "my_source_disk",
      {
    ...
    const googleComputeSnapshotMySourceSnapshot =
      new google.computeSnapshot.ComputeSnapshot(this, "my_source_snapshot", {
        name: "workstation-config",
        provider: googleBeta,
        sourceDisk: cdktf.Token.asString(googleComputeDiskMySourceDisk.name),
        zone: "us-central1-a",
      });
    const googleComputeSubnetworkDefault =
    ...
    googleComputeSubnetworkDefault.overrideLogicalId("default");
    const googleWorkstationsWorkstationClusterDefault =
      new google.WorkstationsWorkstationCluster(this, "default_4", {
        location: "us-central1",
        network: googleComputeNetworkDefault.id,
        provider: googleBeta,
        subnetwork: googleComputeSubnetworkDefault.id,
    ...
    googleWorkstationsWorkstationClusterDefault.overrideLogicalId("default");
    const googleWorkstationsWorkstationConfigDefault =
      new google.WorkstationsWorkstationConfig(this, "default_5", {
        location: googleWorkstationsWorkstationClusterDefault.location,
        persistent_directories: [
          {
            gce_pd: [
              {
                reclaim_policy: "DELETE",
                source_snapshot: googleComputeSnapshotMySourceSnapshot.id,
              },
            ],
            mount_path: "/home",
          },
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleServiceAccountDefault =
      new google.serviceAccount.ServiceAccount(this, "default_3", {
    ...
    const googleKmsCryptoKeyDefault = new google.kmsCryptoKey.KmsCryptoKey(
      ...
      "default_5",
      {
        keyRing: cdktf.Token.asString(googleKmsKeyRingDefault.id),
        name: "workstation-cluster",
        provider: googleBeta,
      }
    );
    ...
    const googleWorkstationsWorkstationConfigDefault =
      new google.WorkstationsWorkstationConfig(this, "default_6", {
        encryption_key: [
          {
...
* `diskType` -
  (Optional)
  The type of the persistent disk for the home directory. Defaults to `pdStandard`.
...
* `sizeGb` -
  ...
  Valid values are `10`, `50`, `100`, `200`, `500`, or `1000`. Defaults to `200`. If less than `200` GB, the `diskType` must be `pdBalanced` or `pdSsd`.
