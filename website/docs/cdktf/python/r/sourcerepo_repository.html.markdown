...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.sourcerepo_repository.SourcerepoRepository(self, "my-repo",
            name="my/repository"
        )
```
<div class = "oics-button" style="float: right; margin: 0 0 -15px">
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.sourcerepo_repository.SourcerepoRepository(self, "my-repo",
            name="my-repository",
            pubsub_configs=[SourcerepoRepositoryPubsubConfigs(
                message_format="JSON",
                service_account_email=cdktf.Token.as_string(google_service_account_test_account.email),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-d99a912f7c21075ca57111d5c24c96b5c786a846b5b0bc3a418975746fd0dc81 -->