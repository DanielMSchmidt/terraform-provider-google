...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_region_backend_service.ComputeRegionBackendService(self, "default_2",
            health_checks=[
        ...
        google.compute_forwarding_rule.ComputeForwardingRule(self, "default_4",
            ...
            depends_on=[google_compute_subnetwork_default],
            ip_protocol="TCP",
        ...
        google_compute_instance_mirror =
        google.compute_instance.ComputeInstance(self, "mirror",
        ...
        google.compute_packet_mirroring.ComputePacketMirroring(self, "foobar",
            collector_ilb=ComputePacketMirroringCollectorIlb(
                url=cdktf.Token.as_string(google_compute_forwarding_rule_default.id)
            ),
            description="bar",
            ...
            mirrored_resources=ComputePacketMirroringMirroredResources(
                instances=[ComputePacketMirroringMirroredResourcesInstances(
                    url=cdktf.Token.as_string(google_compute_instance_mirror.id)
                )
                ],
                tags=["foo"]
            ),
            ...
            network=ComputePacketMirroringNetwork(
                url=cdktf.Token.as_string(google_compute_network_default.id)
            )
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-00091deec198bbf681ab93e6e62d4d92cea6d9ab17ce1290f364a34d2340812f -->