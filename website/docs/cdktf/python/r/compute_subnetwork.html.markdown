...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_network_custom_test =
        google.compute_network.ComputeNetwork(self, "custom-test",
            auto_create_subnetworks=False,
            name="test-network"
        )
        google.compute_subnetwork.ComputeSubnetwork(self, "network-with-private-secondary-ip-ranges",
            ip_cidr_range="10.2.0.0/16",
            name="test-subnetwork",
            network=cdktf.Token.as_string(google_compute_network_custom_test.id),
            region="us-central1",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_subnetwork.ComputeSubnetwork(self, "subnet-with-logging",
            ip_cidr_range="10.2.0.0/16",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_subnetwork.ComputeSubnetwork(self, "network-for-l7lb",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-dcbec8f4196bea1ed541393bfa54bea26c0b2e24c37a1fc529df413af898964c -->