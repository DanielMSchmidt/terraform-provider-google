...
* `googleBigqueryTableIamPolicy`: Retrieves the IAM policy for the table
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-d2db5ff5635ea2e912085472e908751f505ed5b26ec589a3d9dd6079ced03449 -->