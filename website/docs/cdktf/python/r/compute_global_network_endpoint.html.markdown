...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_global_network_endpoint_group_neg =
        google.compute_global_network_endpoint_group.ComputeGlobalNetworkEndpointGroup(self, "neg",
            default_port=cdktf.Token.as_number("90"),
            name="my-lb-neg",
            network_endpoint_type="INTERNET_FQDN_PORT"
        )
        google.compute_global_network_endpoint.ComputeGlobalNetworkEndpoint(self, "default-endpoint",
            fqdn="www.example.com",
            global_network_endpoint_group=cdktf.Token.as_string(google_compute_global_network_endpoint_group_neg.name),
            port=90
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-3c139f01afa9ef2b814a30cf84c9820098452505dd39eed06aae84e6f8c612eb -->