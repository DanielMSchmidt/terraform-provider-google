...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_bigquery_dataset_bar = google.bigquery_dataset.BigqueryDataset(self, "bar",
            dataset_id="job_query_dataset",
            description="This is a test description",
            friendly_name="test",
            location="US"
        )
        google_bigquery_table_foo = google.bigquery_table.BigqueryTable(self, "foo",
            dataset_id=cdktf.Token.as_string(google_bigquery_dataset_bar.dataset_id),
            deletion_protection=False,
            table_id="job_query_table"
        )
        google.bigquery_job.BigqueryJob(self, "job",
            job_id="job_query",
            labels={
            ...
            query=BigqueryJobQuery(
                ...
                destination_table=BigqueryJobQueryDestinationTable(
                    dataset_id=cdktf.Token.as_string(google_bigquery_table_foo.dataset_id),
                    project_id=cdktf.Token.as_string(google_bigquery_table_foo.project),
                    table_id=cdktf.Token.as_string(google_bigquery_table_foo.table_id)
                ),
        ...
        google.bigquery_job.BigqueryJob(self, "job",
            ...
            query=BigqueryJobQuery(
                ...
                default_dataset=BigqueryJobQueryDefaultDataset(
                    dataset_id=cdktf.Token.as_string(google_bigquery_dataset_bar.id)
                ),
                destination_table=BigqueryJobQueryDestinationTable(
                    table_id=cdktf.Token.as_string(google_bigquery_table_foo.id)
                ),
                flatten_results=True,
                query="SELECT state FROM [lookerdata:cdc.project_tycho_reports]",
                script_options=BigqueryJobQueryScriptOptions(
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_bigquery_dataset_dest =
        google.bigquery_dataset.BigqueryDataset(self, "dest",
        ...
        google_bigquery_dataset_source_count = cdktf.TerraformCount.of(
            cdktf.Token.as_number("2"))
        google_bigquery_dataset_source =
        google.bigquery_dataset.BigqueryDataset(self, "source",
            dataset_id="job_copy_${" + google_bigquery_dataset_source_count.index + "}_dataset",
            description="This is a test description",
            friendly_name="test",
            location="US",
            count=google_bigquery_dataset_source_count
        )
        # In most cases loops should be handled in the programming language context and
        #     not inside of the Terraform context. If you are looping over something external, e.g. a variable or a file input
        #     you should consider using a for loop. If you are looping over something only known to Terraform, e.g. a result of a data source
        #     you need to keep this like it is.
        google_bigquery_table_source_count = cdktf.TerraformCount.of(
            cdktf.Fn.length_of(google_bigquery_dataset_source))
        google_bigquery_table_source = google.bigquery_table.BigqueryTable(self, "source_2",
            dataset_id=cdktf.Token.as_string(
                cdktf.property_access(
                    cdktf.property_access(google_bigquery_dataset_source, [google_bigquery_table_source_count.index
                    ]), ["dataset_id"])),
            deletion_protection=False,
            schema="[\n  {\n    \"name\": \"name\",\n    \"type\": \"STRING\",\n    \"mode\": \"NULLABLE\"\n  },\n  {\n    \"name\": \"post_abbr\",\n    \"type\": \"STRING\",\n    \"mode\": \"NULLABLE\"\n  },\n  {\n    \"name\": \"date\",\n    \"type\": \"DATE\",\n    \"mode\": \"NULLABLE\"\n  }\n]\n",
            table_id="job_copy_${" + google_bigquery_table_source_count.index + "}_table",
            count=google_bigquery_table_source_count
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_bigquery_table_source.override_logical_id("source")
        ...
        google.project_iam_member.ProjectIamMember(self, "encrypt_role",
            member="serviceAccount:bq-${" + data_google_project_project.number + "}@bigquery-encryption.iam.gserviceaccount.com",
            project=cdktf.Token.as_string(data_google_project_project.project_id),
            role="roles/cloudkms.cryptoKeyEncrypterDecrypter"
        )
        google_bigquery_table_dest = google.bigquery_table.BigqueryTable(self, "dest_7",
            dataset_id=cdktf.Token.as_string(google_bigquery_dataset_dest.dataset_id),
            deletion_protection=False,
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_bigquery_table_dest.override_logical_id("dest")
        google.bigquery_job.BigqueryJob(self, "job",
            copy=BigqueryJobCopy(
                ...
                destination_table=BigqueryJobCopyDestinationTable(
                    dataset_id=cdktf.Token.as_string(google_bigquery_table_dest.dataset_id),
                    project_id=cdktf.Token.as_string(google_bigquery_table_dest.project),
                    table_id=cdktf.Token.as_string(google_bigquery_table_dest.table_id)
                ),
                source_tables=[BigqueryJobCopySourceTables(
                    dataset_id=cdktf.Token.as_string(
                        cdktf.property_access(google_bigquery_table_source, ["0", "dataset_id"
                        ])),
                    project_id=cdktf.Token.as_string(
                        cdktf.property_access(google_bigquery_table_source, ["0", "project"])),
                    table_id=cdktf.Token.as_string(
                        cdktf.property_access(google_bigquery_table_source, ["0", "table_id"]))
                ), BigqueryJobCopySourceTables(
                    dataset_id=cdktf.Token.as_string(
                        cdktf.property_access(google_bigquery_table_source, ["1", "dataset_id"
                        ])),
                    project_id=cdktf.Token.as_string(
                        cdktf.property_access(google_bigquery_table_source, ["1", "project"])),
                    table_id=cdktf.Token.as_string(
                        cdktf.property_access(google_bigquery_table_source, ["1", "table_id"]))
                )
                ]
            ),
            depends_on=["google_project_iam_member.encrypt_role"],
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_bigquery_dataset_source_one =
        google.bigquery_dataset.BigqueryDataset(self, "source-one",
            dataset_id="job_extract_dataset",
            description="This is a test description",
            friendly_name="test",
            location="US"
        )
        google_bigquery_table_source_one = google.bigquery_table.BigqueryTable(self, "source-one_1",
            dataset_id=cdktf.Token.as_string(google_bigquery_dataset_source_one.dataset_id),
            deletion_protection=False,
            schema="[\n  {\n    \"name\": \"name\",\n    \"type\": \"STRING\",\n    \"mode\": \"NULLABLE\"\n  },\n  {\n    \"name\": \"post_abbr\",\n    \"type\": \"STRING\",\n    \"mode\": \"NULLABLE\"\n  },\n  {\n    \"name\": \"date\",\n    \"type\": \"DATE\",\n    \"mode\": \"NULLABLE\"\n  }\n]\n",
            table_id="job_extract_table"
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_bigquery_table_source_one.override_logical_id("source-one")
        google_storage_bucket_dest = google.storage_bucket.StorageBucket(self, "dest",
            force_destroy=True,
            location="US",
        ...
        google.bigquery_job.BigqueryJob(self, "job",
            extract=BigqueryJobExtract(
                ...
                destination_uris=["${" + google_storage_bucket_dest.url + "}/extract"],
                source_table=BigqueryJobExtractSourceTable(
                    dataset_id=cdktf.Token.as_string(google_bigquery_table_source_one.dataset_id),
                    project_id=cdktf.Token.as_string(google_bigquery_table_source_one.project),
                    table_id=cdktf.Token.as_string(google_bigquery_table_source_one.table_id)
                )
            ),
            job_id="job_extract"
        )
