...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_network_services_tcp_route_default =
        google.NetworkServicesTcpRoute(self, "default_2",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_network_services_tcp_route_default.override_logical_id("default")
```
<div class = "oics-button" style="float: right; margin: 0 0 -15px">
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_backend_service_default.override_logical_id("default")
        google_network_services_tcp_route_default =
        google.NetworkServicesTcpRoute(self, "default_3",
            description="my description",
            labels=[{
                "foo": "bar"
            }
