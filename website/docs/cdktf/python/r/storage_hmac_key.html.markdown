...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_service_account_service_account =
        google.service_account.ServiceAccount(self, "service_account",
            account_id="my-svc-acc"
        )
        google.storage_hmac_key.StorageHmacKey(self, "key",
            service_account_email=cdktf.Token.as_string(google_service_account_service_account.email)
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-cd362b5e4d8bd835d4f3ab482dbc709474b42b2d98f58ee08fe04a65961e5689 -->