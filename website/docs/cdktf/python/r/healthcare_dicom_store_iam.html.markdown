...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.healthcare_dicom_store_iam_policy.HealthcareDicomStoreIamPolicy(self, "dicom_store",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.healthcare_dicom_store_iam_binding.HealthcareDicomStoreIamBinding(self, "dicom_store",
            dicom_store_id="your-dicom-store-id",
            members=["user:jane@example.com"],
            role="roles/editor"
        )
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.healthcare_dicom_store_iam_member.HealthcareDicomStoreIamMember(self, "dicom_store",
            dicom_store_id="your-dicom-store-id",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-04ca8f5dd50563d4236f2f16a20d211d9ade6e7b6f1224d67ea1d74a0c41abc3 -->