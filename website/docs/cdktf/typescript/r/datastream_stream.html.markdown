...
* `schemaFileFormat` -
  ...
  Possible values are: `noSchemaFile`, `avroSchemaFile`.

* `compression` -
  (Optional)
  Compression of the loaded JSON file.
  Possible values are: `noCompression`, `gzip`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-5b758981c36ae71d097baf952345fe6f5a08d4d26866f9548dae97a578aa6e44 -->