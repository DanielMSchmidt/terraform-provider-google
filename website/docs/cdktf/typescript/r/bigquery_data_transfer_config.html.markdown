...
values will be stored in the raw state as plain text: `sensitiveParamsSecretAccessKey`.
  ...
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleBigqueryDatasetMyDataset =
      new google.bigqueryDataset.BigqueryDataset(this, "my_dataset", {
        ...
        dependsOn: [googleProjectIamMemberPermissions],
        description: "bar",
        friendlyName: "foo",
    ...
    new google.bigqueryDataTransferConfig.BigqueryDataTransferConfig(
      ...
      "query_config",
      {
        ...
        dependsOn: [googleProjectIamMemberPermissions],
        destinationDatasetId: cdktf.Token.asString(
          googleBigqueryDatasetMyDataset.datasetId
        ),
