...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_instance_vm = google.compute_instance.ComputeInstance(self, "vm",
        ...
        google.ComputeMachineImage(self, "image",
            name="my-image",
            provider=google_beta,
            source_instance=google_compute_instance_vm.self_link
        )
```
<div class = "oics-button" style="float: right; margin: 0 0 -15px">
    ...
    def __init__(self, scope, name):
        ...
        google.ComputeMachineImage(self, "image",
            machine_image_encryption_key=[{
                "kms_key_name": google_kms_crypto_key_crypto_key.id
            }
            ],
            name="my-image",
            provider=google_beta,
