...
Example creating an empty folder in an existing `imageStore` bucket.
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    new google.storageBucketObject.StorageBucketObject(this, "empty_folder", {
      bucket: "image-store",
      content: " ",
      name: "empty_folder/",
    });
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-17c07731190d5c0c66ba1a13d8a795ec5ad26a6c0b4c4ab3b36bc178c8de571c -->