...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.sql_database.SqlDatabase(self, "database",
            instance=cdktf.Token.as_string(google_sql_database_instance_instance.name),
            name="my-database"
        )
```
<div class = "oics-button" style="float: right; margin: 0 0 -15px">
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-8f6a9ed3b2f69596f81b69c9c2da530595eaadd6d1cf39155332578653d1293d -->