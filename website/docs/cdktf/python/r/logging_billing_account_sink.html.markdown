...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_logging_billing_account_sink_my_sink =
        google.logging_billing_account_sink.LoggingBillingAccountSink(self, "my-sink",
        ...
        google.project_iam_binding.ProjectIamBinding(self, "log-writer",
            members=[
                cdktf.Token.as_string(google_logging_billing_account_sink_my_sink.writer_identity)
            ],
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-55c34dda3a8162f2a8ea17b446cbefe4ad5812320a28c52ecf2865f13a9159ec -->