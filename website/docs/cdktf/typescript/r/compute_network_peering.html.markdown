...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.computeNetworkPeering.ComputeNetworkPeering(this, "peering1", {
      name: "peering1",
      network: cdktf.Token.asString(googleComputeNetworkDefault.selfLink),
      peerNetwork: cdktf.Token.asString(googleComputeNetworkOther.selfLink),
    });
    new google.computeNetworkPeering.ComputeNetworkPeering(this, "peering2", {
      name: "peering2",
      network: cdktf.Token.asString(googleComputeNetworkOther.selfLink),
      peerNetwork: cdktf.Token.asString(googleComputeNetworkDefault.selfLink),
    });
  }
}
