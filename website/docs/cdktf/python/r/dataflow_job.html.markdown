...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.dataflow_job.DataflowJob(self, "big_data_job",
            name="dataflow-job",
            parameters={
                "baz": "qux",
                "foo": "bar"
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_storage_bucket_bucket1 = google.storage_bucket.StorageBucket(self, "bucket1",
            force_destroy=True,
            location="US",
            name="tf-test-bucket1"
        )
        google.storage_bucket.StorageBucket(self, "bucket2",
            force_destroy=True,
            location="US",
            name="tf-test-bucket2"
        )
        google.dataflow_job.DataflowJob(self, "pubsub_stream",
            enable_streaming_engine=True,
            name="tf-test-dataflow-job1",
            on_delete="cancel",
            parameters={
                "input_file_pattern": "${" + google_storage_bucket_bucket1.url + "}/*.json",
                "output_topic": cdktf.Token.as_string(google_pubsub_topic_topic.id)
            },
            temp_gcs_location="gs://my-bucket/tmp_dir",
            template_gcs_path="gs://my-bucket/templates/template_file",
