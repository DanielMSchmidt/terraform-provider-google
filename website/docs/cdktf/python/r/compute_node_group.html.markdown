...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_node_template_soletenant_tmpl =
        google.compute_node_template.ComputeNodeTemplate(self, "soletenant-tmpl",
            name="soletenant-tmpl",
            node_type="n1-node-96-624",
            region="us-central1"
        )
        google.compute_node_group.ComputeNodeGroup(self, "nodes",
            description="example google_compute_node_group for Terraform Google Provider",
            name="soletenant-group",
            node_template=cdktf.Token.as_string(google_compute_node_template_soletenant_tmpl.id),
            size=1,
            zone="us-central1-f"
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-6d7341a9474e1ba6c92c96d5c136a9382575e962bf94e5307b0e539b7d9c1608 -->