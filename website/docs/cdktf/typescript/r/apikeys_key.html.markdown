...
* `service` -
  (Required)
  The service for this restriction. It should be the canonical service name, for example: `translateGoogleapisCom`. You can use `gcloud services list` to get a list of services that are enabled in the project.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-fbb82ebe10138284d6d6cec76721009724eca9556649422c0aa509c9ebe2f45b -->