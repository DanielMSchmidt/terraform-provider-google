...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_folder_my_folder = google.folder.Folder(self, "my-folder",
            display_name="My folder",
            parent="organizations/123456"
        )
        google_storage_bucket_log_bucket = google.storage_bucket.StorageBucket(self, "log-bucket",
            location="US",
            name="folder-logging-bucket"
        )
        google_logging_folder_sink_my_sink =
        google.logging_folder_sink.LoggingFolderSink(self, "my-sink",
            description="some explanation on what this is",
            destination="storage.googleapis.com/${" + google_storage_bucket_log_bucket.name + "}",
            filter="resource.type = gce_instance AND severity >= WARNING",
            folder=cdktf.Token.as_string(google_folder_my_folder.name),
            name="my-sink"
        )
        google.project_iam_binding.ProjectIamBinding(self, "log-writer",
            members=[
                cdktf.Token.as_string(google_logging_folder_sink_my_sink.writer_identity)
            ],
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-d825633480e44d7fb2ed0b846f171a6aa20cd926d5d094d761e52b9615bd0d4b -->