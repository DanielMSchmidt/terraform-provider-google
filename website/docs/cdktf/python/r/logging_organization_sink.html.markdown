...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_logging_organization_sink_my_sink =
        google.logging_organization_sink.LoggingOrganizationSink(self, "my-sink",
        ...
        google.project_iam_member.ProjectIamMember(self, "log-writer",
            member=cdktf.Token.as_string(google_logging_organization_sink_my_sink.writer_identity),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-c5dfb29e305473b01a6257f8bfdbe9cad174866a4caf49930b2ffdcae210cf92 -->