...
* `id` - an identifier for the resource with format `{{egressPolicyName}}/{{resource}}`
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-a446c1b3c0fe41ab389186e37235d1a6cbf6e39d355212f185c0f2674bdba30e -->