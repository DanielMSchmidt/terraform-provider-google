...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_resource_policy_daily_backup =
        google.compute_resource_policy.ComputeResourcePolicy(self, "daily_backup",
            name="every-day-4am",
            region="us-central1",
        ...
        google.service_account.ServiceAccount(self, "default",
        ...
        google_compute_disk_foobar = google.compute_disk.ComputeDisk(self, "foobar",
        ...
        google.compute_instance_template.ComputeInstanceTemplate(self, "default_4",
            ...
            disk=[ComputeInstanceTemplateDisk(
                ...
                boot=True,
                resource_policies=[
                    cdktf.Token.as_string(google_compute_resource_policy_daily_backup.id)
                ],
                source_image="debian-cloud/debian-11"
            ), ComputeInstanceTemplateDisk(
                auto_delete=False,
                boot=False,
                source=cdktf.Token.as_string(google_compute_disk_foobar.name)
            )
            ],
            ...
            service_account=ComputeInstanceTemplateServiceAccount(
                email=cdktf.Token.as_string(google_service_account_default.email),
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_instance_template.ComputeInstanceTemplate(self, "foobar",
            can_ip_forward=False,
            disk=[ComputeInstanceTemplateDisk(
                auto_delete=True,
                boot=True,
                source_image=cdktf.Token.as_string(data_google_compute_image_my_image.self_link)
            )
            ],
            labels={
            ...
            service_account=ComputeInstanceTemplateServiceAccount(
                email=cdktf.Token.as_string(data_google_compute_default_service_account_default.email),
                scopes=["cloud-platform"]
            ),
            tags=["foo", "bar"]
        )
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-f2e2b2e21b902679e54bf927bf5722df524d93651e57ffd780d54dd7419e9863 -->