...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_global_address_default =
        google.compute_global_address.ComputeGlobalAddress(self, "default",
            name="tcp-proxy-xlb-ip",
            provider=google_beta
        )
        google_compute_health_check_default =
        google.compute_health_check.ComputeHealthCheck(self, "default_1",
            check_interval_sec=1,
        ...
        google_compute_health_check_default.override_logical_id("default")
        google_compute_network_default =
        google.compute_network.ComputeNetwork(self, "default_2",
            auto_create_subnetworks=False,
        ...
        google_compute_firewall_default =
        google.compute_firewall.ComputeFirewall(self, "default_4",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_compute_firewall_default.override_logical_id("default")
        google_compute_instance_template_default =
        google.compute_instance_template.ComputeInstanceTemplate(self, "default_5",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_compute_instance_template_default.override_logical_id("default")
        google_compute_instance_group_manager_default =
        google.compute_instance_group_manager.ComputeInstanceGroupManager(self, "default_6",
            base_instance_name="vm",
            name="tcp-proxy-xlb-mig1",
            named_port=[ComputeInstanceGroupManagerNamedPort(
                name="tcp",
                port=80
            )
            ],
            ...
            version=[ComputeInstanceGroupManagerVersion(
                instance_template=cdktf.Token.as_string(google_compute_instance_template_default.id),
                name="primary"
            )
            ],
            zone="us-central1-c"
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_compute_instance_group_manager_default.override_logical_id("default")
        google_compute_backend_service_default =
        google.compute_backend_service.ComputeBackendService(self, "default_7",
            backend=[ComputeBackendServiceBackend(
                balancing_mode="UTILIZATION",
                capacity_scaler=1,
                group=cdktf.Token.as_string(google_compute_instance_group_manager_default.instance_group),
                max_utilization=1
            )
            ],
            health_checks=[
        ...
        google.compute_target_tcp_proxy.ComputeTargetTcpProxy(self, "default_8",
        ...
        google.compute_global_forwarding_rule.ComputeGlobalForwardingRule(self, "default_9",
            ip_address=cdktf.Token.as_string(google_compute_global_address_default.id),
            ip_protocol="TCP",
            load_balancing_scheme="EXTERNAL",
            name="tcp-proxy-xlb-forwarding-rule",
            port_range="110",
            provider=google_beta,
            target=cdktf.Token.as_string(google_compute_target_tcp_proxy_default.id)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_compute_backend_service_default.override_logical_id("default")
        google_compute_url_map_default = google.compute_url_map.ComputeUrlMap(self, "default_8",
        ...
        google.compute_target_http_proxy.ComputeTargetHttpProxy(self, "default_9",
        ...
        google_compute_global_forwarding_rule_default =
        google.compute_global_forwarding_rule.ComputeGlobalForwardingRule(self, "default_10",
            ip_address=cdktf.Token.as_string(google_compute_global_address_default.id),
            ip_protocol="TCP",
            load_balancing_scheme="EXTERNAL",
            ...
            port_range="80",
            provider=google_beta,
            target=cdktf.Token.as_string(google_compute_target_http_proxy_default.id)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_compute_global_forwarding_rule_default.override_logical_id("default")
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_target_http_proxy_default.override_logical_id("default")
        google_compute_global_forwarding_rule_default =
        google.compute_global_forwarding_rule.ComputeGlobalForwardingRule(self, "default_4",
            name="global-rule",
            port_range="80",
            target=cdktf.Token.as_string(google_compute_target_http_proxy_default.id)
        )
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_instance_group_manager_igm =
        google.compute_instance_group_manager.ComputeInstanceGroupManager(self, "igm",
        ...
        google_compute_backend_service_default =
        google.compute_backend_service.ComputeBackendService(self, "default_4",
            backend=[ComputeBackendServiceBackend(
                balancing_mode="RATE",
                capacity_scaler=0.4,
                group=cdktf.Token.as_string(google_compute_instance_group_manager_igm.instance_group),
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_compute_backend_service_default.override_logical_id("default")
        google_compute_url_map_default = google.compute_url_map.ComputeUrlMap(self, "default_5",
            default_service=cdktf.Token.as_string(google_compute_backend_service_default.id),
            description="a description",
            host_rule=[ComputeUrlMapHostRule(
                hosts=["mysite.com"],
        ...
        google_compute_url_map_default.override_logical_id("default")
        google_compute_target_http_proxy_default =
        google.compute_target_http_proxy.ComputeTargetHttpProxy(self, "default_6",
            description="a description",
            name="target-proxy",
            provider=google_beta,
            url_map=cdktf.Token.as_string(google_compute_url_map_default.id)
        ...
        google_compute_target_http_proxy_default.override_logical_id("default")
        google_compute_global_forwarding_rule_default =
        google.compute_global_forwarding_rule.ComputeGlobalForwardingRule(self, "default_7",
            ip_address="0.0.0.0",
            load_balancing_scheme="INTERNAL_SELF_MANAGED",
            metadata_filters=[ComputeGlobalForwardingRuleMetadataFilters(
                filter_labels=[ComputeGlobalForwardingRuleMetadataFiltersFilterLabels(
                    name="PLANET",
                    value="MARS"
                )
                ],
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_subnetwork.ComputeSubnetwork(self, "vpc_subnetwork",
            ip_cidr_range="10.2.0.0/16",
            name="my-subnetwork",
            network=cdktf.Token.as_string(google_compute_network_network.id),
            private_ip_google_access=True,
            project=cdktf.Token.as_string(google_compute_network_network.project),
            provider=google_beta,
            region="us-central1"
        )
        google_compute_global_address_default =
        ...
        google_compute_global_forwarding_rule_default =
        google.compute_global_forwarding_rule.ComputeGlobalForwardingRule(self, "default_3",
            ip_address=cdktf.Token.as_string(google_compute_global_address_default.id),
            load_balancing_scheme="",
            name="globalrule",
            network=google_compute_network_network.id,
            project=cdktf.Token.as_string(google_compute_network_network.project),
            provider=google_beta,
            target="all-apis"
        )
