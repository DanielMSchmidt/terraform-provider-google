...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_node_template.ComputeNodeTemplate(self, "template",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.data_google_compute_node_types.DataGoogleComputeNodeTypes(self, "central1a",
            zone="us-central1-a"
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-8fd902f760808e790a2508d1b633d4008b6c7658c6cf498966ea365f4ac0fa1c -->