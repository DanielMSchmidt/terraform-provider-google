...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_security_policy.ComputeSecurityPolicy(self, "policy",
            name="my-policy",
            rule=[ComputeSecurityPolicyRule(
                action="deny(403)",
                ...
                priority=cdktf.Token.as_number("1000")
                ...
                priority=cdktf.Token.as_number("2147483647")
            )
            ]
        )
```
