...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_cloud_identity_group_child_group =
        google.cloud_identity_group.CloudIdentityGroup(self, "child-group",
        ...
        google.cloud_identity_group_membership.CloudIdentityGroupMembership(self, "cloud_identity_group_membership_basic",
            group=cdktf.Token.as_string(google_cloud_identity_group_group.id),
            preferred_member_key=CloudIdentityGroupMembershipPreferredMemberKey(
                id=cdktf.Token.as_string(
                    cdktf.property_access(google_cloud_identity_group_child_group.group_key, ["0", "id"
                    ]))
            ),
            roles=[CloudIdentityGroupMembershipRoles(
                name="MEMBER"
            )
            ]
        )
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-530eba2d96fdae7b355bc2f5a3182d45c2004dde90aeed5d499c052e0705a3c4 -->