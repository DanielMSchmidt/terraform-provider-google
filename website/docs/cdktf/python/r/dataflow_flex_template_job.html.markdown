...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.DataflowFlexTemplateJob(self, "big_data_job",
            container_spec_gcs_path="gs://my-bucket/templates/template.json",
            name="dataflow-flextemplates-job",
            parameters=[{
                "input_subscription": "messages"
            }
            ],
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-25396cf63dbb86ee53cc1c207c0ca74874eb3c68eb8d291d9172327a97208ef5 -->