...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_router_peer.ComputeRouterPeer(self, "peer",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-6565b1b265c82f75fdbe6be8321659748a24f5c7c6d8ad61b6239c5e2eff2066 -->