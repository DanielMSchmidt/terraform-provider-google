...
- `name` - (Optional) The name of the instance template. One of `name`, `filter` or `selfLinkUnique` must be provided.
...
- `selfLinkUnique` - (Optional) The self_link_unique URI of the instance template. One of `name`, `filter` or `selfLinkUnique` must be provided.

- `mostRecent` - (Optional) If `filter` is provided, ensures the most recent template is returned when multiple instance templates match. One of `name`, `filter` or `selfLinkUnique` must be provided.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-46c5c4f2961aa2768d5f48fd6362684be6e915afc84ac72fea24452e50b003fa -->