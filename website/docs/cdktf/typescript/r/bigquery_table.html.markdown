...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    const googleBigqueryDatasetDefault =
      new google.bigqueryDataset.BigqueryDataset(this, "default", {
        datasetId: "foo",
    ...
    const googleBigqueryTableDefault = new google.bigqueryTable.BigqueryTable(
      ...
      "default_1",
      {
        datasetId: cdktf.Token.asString(googleBigqueryDatasetDefault.datasetId),
        labels: {
          env: "default",
        },
        schema:
...
* `sourceFormat` (Required) - The data format. Please see sourceFormat under
...
<a name="nested_materialized_view"></a>The `materializedView` block supports:
