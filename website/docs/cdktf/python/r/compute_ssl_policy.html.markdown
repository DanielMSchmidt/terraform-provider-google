...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_ssl_policy.ComputeSslPolicy(self, "custom-ssl-policy",
        ...
        google.compute_ssl_policy.ComputeSslPolicy(self, "nonprod-ssl-policy",
            min_tls_version="TLS_1_2",
            name="nonprod-ssl-policy",
            profile="MODERN"
        )
        google.compute_ssl_policy.ComputeSslPolicy(self, "prod-ssl-policy",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-a3aa7f3283b345109e39ff7281ff3ba9ddc88ffd5994d04c8bbcb2ac15b769dd -->