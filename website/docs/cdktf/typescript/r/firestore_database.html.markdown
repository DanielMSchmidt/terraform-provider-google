...
[`googleAppEngineApplication`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/app_engine_application)
resource instead.
...
* `type` -
  ...
  Possible values are: `firestoreNative`, `datastoreMode`.
...
* `concurrencyMode` -
  ...
  Possible values are: `optimistic`, `pessimistic`, `optimisticWithEntityGroups`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-67bdafbe8b016235aaf76aa3012b0706ff36445f160a968b6b00e950921790bb -->