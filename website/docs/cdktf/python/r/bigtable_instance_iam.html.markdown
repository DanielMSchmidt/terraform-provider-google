...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.bigtable_instance_iam_policy.BigtableInstanceIamPolicy(self, "editor",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.bigtable_instance_iam_binding.BigtableInstanceIamBinding(self, "editor",
            instance="your-bigtable-instance",
            members=["user:jane@example.com"],
            role="roles/bigtable.user"
        )
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.bigtable_instance_iam_member.BigtableInstanceIamMember(self, "editor",
            instance="your-bigtable-instance",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-82d8c1429563933c0e21bc207e73dbaa6fbd1062ee011ed78a55f8f26b80fd95 -->