...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.healthcare_consent_store.HealthcareConsentStore(self, "my-consent",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_service_account_test_account =
        google.service_account.ServiceAccount(self, "test-account",
            account_id="my-account",
            display_name="Test Service Account"
        )
        google_healthcare_consent_store_my_consent =
        google.healthcare_consent_store.HealthcareConsentStore(self, "my-consent",
            dataset=cdktf.Token.as_string(google_healthcare_dataset_dataset.id),
            name="my-consent-store"
        )
        google.healthcare_consent_store_iam_member.HealthcareConsentStoreIamMember(self, "test-iam",
            consent_store_id=cdktf.Token.as_string(google_healthcare_consent_store_my_consent.name),
            dataset=cdktf.Token.as_string(google_healthcare_dataset_dataset.id),
            member="serviceAccount:${" + google_service_account_test_account.email + "}",
            role="roles/editor"
        )
```
