...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googlePubsubLiteTopicExample =
      new google.pubsubLiteTopic.PubsubLiteTopic(this, "example", {
        name: "example-topic",
        partitionConfig: {
          capacity: {
            publishMibPerSec: 4,
        ...
        project: cdktf.Token.asString(dataGoogleProjectProject.number),
        retentionConfig: {
          perPartitionBytes: cdktf.Token.asString(32212254720),
        },
      });
    const googlePubsubLiteSubscriptionExample =
      new google.pubsubLiteSubscription.PubsubLiteSubscription(
        this,
        "example_2",
        {
          deliveryConfig: {
          ...
          topic: cdktf.Token.asString(googlePubsubLiteTopicExample.name),
        }
      );
...
* `deliveryRequirement` -
  ...
  Possible values are: `deliverImmediately`, `deliverAfterStored`, `deliveryRequirementUnspecified`.
