...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleComputeForwardingRuleDefault =
      new google.computeForwardingRule.ComputeForwardingRule(
        ...
        "default_4",
        {
          ...
          dependsOn: [googleComputeSubnetworkDefault],
          ipProtocol: "TCP",
    ...
    const googleComputeInstanceMirror =
      new google.computeInstance.ComputeInstance(this, "mirror", {
        bootDisk: {
          initializeParams: {
    ...
    new google.computePacketMirroring.ComputePacketMirroring(this, "foobar", {
      collectorIlb: {
        url: cdktf.Token.asString(googleComputeForwardingRuleDefault.id),
      },
      description: "bar",
      filter: {
      ...
      mirroredResources: {
        instances: [
          {
            url: cdktf.Token.asString(googleComputeInstanceMirror.id),
          },
        ],
        tags: ["foo"],
      },
      name: "my-mirroring",
      network: {
        url: cdktf.Token.asString(googleComputeNetworkDefault.id),
      },
    });
  }
}
