...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.cloudiot_registry.CloudiotRegistry(self, "test-registry",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_pubsub_topic_default_telemetry =
        google.pubsub_topic.PubsubTopic(self, "default-telemetry",
            name="default-telemetry"
        )
        google.cloudiot_registry.CloudiotRegistry(self, "test-registry",
            event_notification_configs=[CloudiotRegistryEventNotificationConfigs(
                pubsub_topic_name=cdktf.Token.as_string(google_pubsub_topic_default_telemetry.id),
                subfolder_matches=""
            )
            ],
            name="cloudiot-registry"
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-9d09ea5a6ae0bc387647a8f72df95423982d26ebc2265ffe09b63628373b2e0b -->