...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_tags_tag_key_key = google.tags_tag_key.TagsTagKey(self, "key",
            description="For keyname resources.",
            parent="organizations/123456789",
            short_name="keyname"
        )
        google.tags_tag_value.TagsTagValue(self, "value",
            description="For valuename resources.",
            parent="tagKeys/${" + google_tags_tag_key_key.name + "}",
