    ...
    new google.binaryAuthorizationAttestor.BinaryAuthorizationAttestor(
      ...
      "attestor",
      {
        attestationAuthorityNote: {
          noteReference: cdktf.Token.asString(
            googleContainerAnalysisNoteNote.name
          ),
          publicKeys: [
            {
    ...
    new google.binaryAuthorizationAttestor.BinaryAuthorizationAttestor(
      ...
      "attestor",
      {
        attestationAuthorityNote: {
          ...
          publicKeys: [
            {
              id: cdktf.Token.asString(dataGoogleKmsCryptoKeyVersionVersion.id),
              pkixPublicKey: {
                publicKeyPem: cdktf.Token.asString(
                  cdktf.propertyAccess(
                    dataGoogleKmsCryptoKeyVersionVersion.publicKey,
                    ["0", "pem"]
                  )
                ),
                signatureAlgorithm: cdktf.Token.asString(
                  cdktf.propertyAccess(
                    dataGoogleKmsCryptoKeyVersionVersion.publicKey,
                    ["0", "algorithm"]
                  )
