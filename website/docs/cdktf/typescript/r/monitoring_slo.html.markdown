...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.monitoringSlo.MonitoringSlo(this, "request_based_slo", {
      displayName:
        "Terraform Test SLO with request based SLI (good total ratio)",
      goal: 0.9,
      requestBasedSli: {
        distributionCut: {
          distributionFilter:
      ...
      service: cdktf.Token.asString(
        googleMonitoringCustomServiceCustomsrv.serviceId
      ),
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.monitoringSlo.MonitoringSlo(this, "windows_based", {
      ...
      windowsBasedSli: {
        goodBadMetricFilter: cdktf.Fn.join(
          " AND ",
          cdktf.Token.asList([
    ...
    new google.monitoringSlo.MonitoringSlo(this, "windows_based", {
      ...
      windowsBasedSli: {
        goodTotalRatioThreshold: {
          performance: {
            distributionCut: {
              distributionFilter: cdktf.Fn.join(
                " AND ",
                cdktf.Token.asList([
