...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.computeNetwork.ComputeNetwork(this, "vpc_network", {
      autoCreateSubnetworks: cdktf.Token.asBoolean("true"),
...
run `terraform plan`, you will see that `"terraformInstance"` depends on
`"terraformNetwork"`.
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleComputeNetworkVpcNetwork =
      new google.computeNetwork.ComputeNetwork(this, "vpc_network", {
        autoCreateSubnetworks: cdktf.Token.asBoolean("true"),
        name: "terraform-network",
      });
      ...
      networkInterface: [
        {
          ...
          network: cdktf.Token.asString(
            googleComputeNetworkVpcNetwork.selfLink
          ),
        },
      ],
    });
