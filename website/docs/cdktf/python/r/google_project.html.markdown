...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.project.Project(self, "my_project-in-a-folder",
            folder_id=cdktf.Token.as_string(google_folder_department1.name),
            name="My Project",
            project_id="your-project-id"
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-22214377ad412bed0eed2fba5c6304115e9bc8d316cd0009978ba07ab45e104a -->