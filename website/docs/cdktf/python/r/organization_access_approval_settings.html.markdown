...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.organization_access_approval_settings.OrganizationAccessApprovalSettings(self, "organization_access_approval",
            enrolled_services=[OrganizationAccessApprovalSettingsEnrolledServices(
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-b9578f4630177398129e21a059c9fe0d417a4e168aa2784a78497d401d801f5d -->