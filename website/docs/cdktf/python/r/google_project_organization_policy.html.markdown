...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.project_organization_policy.ProjectOrganizationPolicy(self, "serial_port_policy",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.project_organization_policy.ProjectOrganizationPolicy(self, "services_policy",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-5428b7dcfe4c7f75cb924407e1578bd38077700ae99fcd3acd93124665e0189c -->