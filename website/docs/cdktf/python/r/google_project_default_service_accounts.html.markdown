...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.project_default_service_accounts.ProjectDefaultServiceAccounts(self, "my_project",
            action="DELETE",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e9862a1b31b7920d53f33b878fbba409680fa11a7132f0be91f752f4a677ccdc -->