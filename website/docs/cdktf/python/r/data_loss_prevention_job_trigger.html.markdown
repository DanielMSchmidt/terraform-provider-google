...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.data_loss_prevention_job_trigger.DataLossPreventionJobTrigger(self, "basic",
            description="Description",
            display_name="Displayname",
            inspect_job=DataLossPreventionJobTriggerInspectJob(
                actions=[DataLossPreventionJobTriggerInspectJobActions(
            ...
            triggers=[DataLossPreventionJobTriggerTriggers(
