...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_project_project = google.project.Project(self, "project",
            name="my-project",
            org_id="123456789",
            project_id="my-project"
        )
        google_project_service_project_service =
        google.project_service.ProjectService(self, "project_service",
            project=cdktf.Token.as_string(google_project_project.project_id),
            service="iap.googleapis.com"
        )
        google_iap_brand_project_brand = google.iap_brand.IapBrand(self, "project_brand",
            application_title="Cloud IAP protected Application",
            project=cdktf.Token.as_string(google_project_service_project_service.project),
            support_email="support@example.com"
        )
        google.iap_client.IapClient(self, "project_client",
            brand=cdktf.Token.as_string(google_iap_brand_project_brand.name),
