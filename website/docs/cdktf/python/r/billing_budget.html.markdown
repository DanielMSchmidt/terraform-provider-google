...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_google_billing_account_account =
        google.data_google_billing_account.DataGoogleBillingAccount(self, "account",
            billing_account="000000-0000000-0000000-000000"
        )
        google.billing_budget.BillingBudget(self, "budget",
            ...
            billing_account=cdktf.Token.as_string(data_google_billing_account_account.id),
            display_name="Example Billing Budget",
            threshold_rules=[BillingBudgetThresholdRules(
    ...
    def __init__(self, scope, name):
        ...
        google.billing_budget.BillingBudget(self, "budget",
            ...
            budget_filter=BillingBudgetBudgetFilter(
                projects=["projects/${" + data_google_project_project.number + "}"]
            ),
            display_name="Example Billing Budget",
            threshold_rules=[BillingBudgetThresholdRules(
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_monitoring_notification_channel_notification_channel =
        google.monitoring_notification_channel.MonitoringNotificationChannel(self, "notification_channel",
        ...
        google.billing_budget.BillingBudget(self, "budget",
            all_updates_rule=BillingBudgetAllUpdatesRule(
                ...
                monitoring_notification_channels=[
                    cdktf.Token.as_string(google_monitoring_notification_channel_notification_channel.id)
                ]
            ),
            amount=BillingBudgetAmount(
                specified_amount=BillingBudgetAmountSpecifiedAmount(
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-501a14631cd929cbd1e1e0c446e208dca857db1a728602d8dc55be8eb0612f87 -->