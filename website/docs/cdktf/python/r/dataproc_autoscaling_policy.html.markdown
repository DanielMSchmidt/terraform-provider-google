...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_dataproc_autoscaling_policy_asp =
        google.dataproc_autoscaling_policy.DataprocAutoscalingPolicy(self, "asp",
        ...
        google.dataproc_cluster.DataprocCluster(self, "basic",
            cluster_config=DataprocClusterClusterConfig(
                autoscaling_config=DataprocClusterClusterConfigAutoscalingConfig(
                    policy_uri=cdktf.Token.as_string(google_dataproc_autoscaling_policy_asp.name)
                )
            ),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-05a54acd6a2ced4d51f107e868b594b49288cf4208ed46f20660362d8d920656 -->