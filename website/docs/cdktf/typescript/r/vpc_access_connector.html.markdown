...
* `network` -
  (Optional)
  Name or self_link of the VPC network. Required if `ipCidrRange` is set.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-d9443a813896c37b12db8997a302ce7857bc0bb57bc67f1cb25898cf075a030f -->