...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_pubsub_lite_topic_example =
        google.pubsub_lite_topic.PubsubLiteTopic(self, "example",
            name="example-topic",
            ...
            project=cdktf.Token.as_string(data_google_project_project.number),
            retention_config=PubsubLiteTopicRetentionConfig(
                per_partition_bytes=cdktf.Token.as_string(32212254720)
            )
        )
        google_pubsub_lite_subscription_example =
        google.pubsub_lite_subscription.PubsubLiteSubscription(self, "example_2",
            delivery_config=PubsubLiteSubscriptionDeliveryConfig(
                delivery_requirement="DELIVER_AFTER_STORED"
            ),
            name="example-subscription",
            topic=cdktf.Token.as_string(google_pubsub_lite_topic_example.name)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_pubsub_lite_subscription_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-7a8a8db24a9b28549b3f209e18f2dd66dbb14785a79ef77ce827064a0731e66d -->