...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_app_engine_standard_app_version_admin_v3 =
        google.app_engine_standard_app_version.AppEngineStandardAppVersion(self, "admin_v3",
        ...
        google.app_engine_application_url_dispatch_rules.AppEngineApplicationUrlDispatchRules(self, "web_service",
            dispatch_rules=[AppEngineApplicationUrlDispatchRulesDispatchRules(
                domain="*",
                path="/*",
                service="default"
                ...
                domain="*",
                path="/admin/*",
                service=cdktf.Token.as_string(google_app_engine_standard_app_version_admin_v3.service)
            )
            ]
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-bd25a083bab754577f6da4c2eedf4d4aa37a70979fb31267d23a657349bfc6b6 -->