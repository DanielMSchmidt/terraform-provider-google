...
* `id` - an identifier for the resource with format `{{ingressPolicyName}}/{{resource}}`
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-5de7385a5989a0da3500ef8b927f6f3b2e67db0dadbdf43076a5d5d03b085052 -->