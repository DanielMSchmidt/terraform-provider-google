...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.organization_iam_policy.OrganizationIamPolicy(self, "organization",
            org_id="1234567890",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.organization_iam_binding.OrganizationIamBinding(self, "organization",
            members=["user:jane@example.com"],
            org_id="1234567890",
            role="roles/editor"
        )
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.organization_iam_member.OrganizationIamMember(self, "organization",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.organization_iam_audit_config.OrganizationIamAuditConfig(self, "organization",
            audit_log_config=[OrganizationIamAuditConfigAuditLogConfig(
                log_type="ADMIN_READ"
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-78b971cadf53162cf64597787cb9c1f9f39ae685025dd81d91e2e77d59f20d94 -->