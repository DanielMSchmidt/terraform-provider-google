...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.healthcare_hl7_v2_store.HealthcareHl7V2Store(self, "store",
            dataset=cdktf.Token.as_string(google_healthcare_dataset_dataset.id),
            labels={
                "label1": "labelvalue1"
            },
            name="example-hl7-v2-store",
            notification_configs=[HealthcareHl7V2StoreNotificationConfigs(
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-6338ef117522530dd3ae9eb6e94562fd50448818d8045f6284f2ec8a8656d497 -->