...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.compute_firewall.ComputeFirewall(self, "default_1",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.compute_firewall.ComputeFirewall(self, "rules",
            allow=[ComputeFirewallAllow(
                ports=["80", "8080", "1000-2000"],
                protocol="tcp"
            )
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-472485607a19a19ab6461f701767babc363a1299f8d07eb2a4ee6efe9bd5815f -->