...
* `instanceTemplate` - (Required) - The full URL to an instance template from which all new instances of this version will be created. It is recommended to reference instance templates through their unique id (`selfLinkUnique` attribute).
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-6ae7f94ab20a63402f084c29076b000e62340266775ff260973fc9bfe9dde6ae -->