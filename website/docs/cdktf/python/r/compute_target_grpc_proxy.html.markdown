...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_url_map_urlmap = google.compute_url_map.ComputeUrlMap(self, "urlmap",
        ...
        google_compute_target_grpc_proxy_default =
        google.compute_target_grpc_proxy.ComputeTargetGrpcProxy(self, "default_3",
            name="proxy",
            url_map=cdktf.Token.as_string(google_compute_url_map_urlmap.id),
            validate_for_proxyless=True
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_compute_target_grpc_proxy_default.override_logical_id("default")
```
