...
* `postStartupScriptBehavior` -
  ...
  Possible values are: `postStartupScriptBehaviorUnspecified`, `runEveryStart`, `downloadAndRunEveryStart`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-791fcc1537dbb8785ee45e28aa454c1f57861b15b931d5ba763d2eca20d8fb58 -->