...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_gkeonprem_bare_metal_cluster_default_basic =
        google.GkeonpremBareMetalCluster(self, "default-basic",
        ...
        google.GkeonpremBareMetalNodePool(self, "nodepool-basic",
            bare_metal_cluster=google_gkeonprem_bare_metal_cluster_default_basic.name,
            location="us-west1",
            name="np-nodepool",
            node_pool_config=[{
                "node_configs": [{
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_gkeonprem_bare_metal_cluster_default_full =
        google.GkeonpremBareMetalCluster(self, "default-full",
            admin_cluster_membership="projects/870316890899/locations/global/memberships/gkeonprem-terraform-test",
            bare_metal_version="1.12.3",
            control_plane=[{
                "control_plane_node_pool_config": [{
        ...
        google.GkeonpremBareMetalNodePool(self, "nodepool-full",
            annotations=[{}],
            bare_metal_cluster=google_gkeonprem_bare_metal_cluster_default_full.name,
