...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_instance_frontend =
        google.compute_instance.ComputeInstance(self, "frontend",
        ...
        google_dns_record_set_frontend = google.dns_record_set.DnsRecordSet(self, "frontend_2",
            ...
            rrdatas=[
                cdktf.Token.as_string(
                    cdktf.property_access(google_compute_instance_frontend.network_interface, ["0", "access_config", "0", "nat_ip"]))
            ],
            ttl=300,
            type="A"
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_dns_record_set_frontend.override_logical_id("frontend")
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.dns_record_set.DnsRecordSet(self, "a",
            managed_zone=cdktf.Token.as_string(google_dns_managed_zone_prod.name),
            name="backend.${" + google_dns_managed_zone_prod.dns_name + "}",
            rrdatas=["8.8.8.8"],
            ttl=300,
            type="A"
        )
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.dns_record_set.DnsRecordSet(self, "mx",
            managed_zone=cdktf.Token.as_string(google_dns_managed_zone_prod.name),
            name=cdktf.Token.as_string(google_dns_managed_zone_prod.dns_name),
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.dns_record_set.DnsRecordSet(self, "spf",
            managed_zone=cdktf.Token.as_string(google_dns_managed_zone_prod.name),
            name="frontend.${" + google_dns_managed_zone_prod.dns_name + "}",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.dns_record_set.DnsRecordSet(self, "cname",
            managed_zone=cdktf.Token.as_string(google_dns_managed_zone_prod.name),
            name="frontend.${" + google_dns_managed_zone_prod.dns_name + "}",
