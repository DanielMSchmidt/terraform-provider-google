...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.kms_key_ring_iam_policy.KmsKeyRingIamPolicy(self, "key_ring",
            key_ring_id=cdktf.Token.as_string(google_kms_key_ring_keyring.id),
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.kms_key_ring_iam_binding.KmsKeyRingIamBinding(self, "key_ring",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.kms_key_ring_iam_member.KmsKeyRingIamMember(self, "key_ring",
            key_ring_id="your-key-ring-id",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-c63908a144aae7bb30639ceb97d9a476cfee31c2fc2b50c6d0e7dd7bf30b881c -->