...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.bigtable_table_iam_policy.BigtableTableIamPolicy(self, "editor",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.bigtable_table_iam_binding.BigtableTableIamBinding(self, "editor",
            instance="your-bigtable-instance",
            members=["user:jane@example.com"],
            role="roles/bigtable.user",
            table="your-bigtable-table"
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.bigtable_table_iam_member.BigtableTableIamMember(self, "editor",
            instance="your-bigtable-instance",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-652efd63b21e4dfb23f6496d53c50812b0ccad5541179c4b87eedb9a7aa8c8a7 -->