...
* `instanceType` -
  ...
  Possible values are: `primary`, `readPool`.
...
* `availabilityType` -
  ...
  Possible values are: `availabilityTypeUnspecified`, `zonal`, `regional`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-8f97e04ee25fb0d17b7edbcffa2e96a5c690def6bc612ac228a6a6a15cc4d714 -->