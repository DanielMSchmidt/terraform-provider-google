...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.folder_organization_policy.FolderOrganizationPolicy(self, "serial_port_policy",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.folder_organization_policy.FolderOrganizationPolicy(self, "services_policy",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-a22ae436848655dd2c620881009e3a1c8fd4633a6c895fffcdbef17ceea40871 -->