      ...
      new google.bigqueryDatasetIamPolicy.BigqueryDatasetIamPolicy(
        ...
        "dataset_2",
        {
          datasetId: cdktf.Token.asString(
            googleBigqueryDatasetDataset.datasetId
          ),
          policyData: cdktf.Token.asString(dataGoogleIamPolicyOwner.policyData),
        }
      );
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.bigqueryDatasetIamBinding.BigqueryDatasetIamBinding(
      this,
      "reader",
      {
