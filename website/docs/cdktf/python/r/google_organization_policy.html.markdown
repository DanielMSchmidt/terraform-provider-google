...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.organization_policy.OrganizationPolicy(self, "serial_port_policy",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.organization_policy.OrganizationPolicy(self, "services_policy",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-2bf01ddb0cc30fff8360fbf7e9d1eec6912a509389cb2e246b77a613eaa00532 -->