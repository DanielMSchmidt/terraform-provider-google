...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.notebooksInstance.NotebooksInstance(this, "instance", {
      ...
      name: "notebooks-instance",
      network: cdktf.Token.asString(dataGoogleComputeNetworkMyNetwork.id),
      noProxyAccess: true,
      noPublicIp: true,
      serviceAccount: "my@service-account.com",
      subnet: cdktf.Token.asString(dataGoogleComputeSubnetworkMySubnetwork.id),
      vmImage: {
        imageFamily: "tf-latest-cpu",
        project: "deeplearning-platform-release",
      },
...
* `nicType` -
  ...
  Possible values are: `unspecifiedNicType`, `virtioNet`, `gvnic`.
...
* `bootDiskType` -
  ...
  Possible values are: `diskTypeUnspecified`, `pdStandard`, `pdSsd`, `pdBalanced`, `pdExtreme`.
...
* `diskEncryption` -
  ...
  Possible values are: `diskEncryptionUnspecified`, `gmek`, `cmek`.
...
* `type` -
  ...
  Possible values are: `acceleratorTypeUnspecified`, `nvidiaTeslaK80`, `nvidiaTeslaP100`, `nvidiaTeslaV100`, `nvidiaTeslaP4`, `nvidiaTeslaT4`, `nvidiaTeslaT4Vws`, `nvidiaTeslaP100Vws`, `nvidiaTeslaP4Vws`, `nvidiaTeslaA100`, `tpuV2`, `tpuV3`.
...
* `consumeReservationType` -
  ...
  Possible values are: `noReservation`, `anyReservation`, `specificReservation`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-26c93ab4645922dabf9a15f9807b32b2c495d82160177f928adf7212596bbb9b -->