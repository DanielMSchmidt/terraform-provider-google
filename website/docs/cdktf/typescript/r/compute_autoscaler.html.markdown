          ...
          disk: [
            {
              sourceImage: cdktf.Token.asString(
                dataGoogleComputeImageDebian9.id
              ),
            },
          ],
    ...
    const googleComputeInstanceGroupManagerFoobar =
      new google.computeInstanceGroupManager.ComputeInstanceGroupManager(
        ...
        "foobar_3",
        {
          ...
          name: "my-igm",
          targetPools: [cdktf.Token.asString(googleComputeTargetPoolFoobar.id)],
          version: [
            {
              instanceTemplate: cdktf.Token.asString(
                googleComputeInstanceTemplateFoobar.id
              ),
              name: "primary",
            },
          ],
    ...
    const googleComputeAutoscalerFoobar =
      new google.computeAutoscaler.ComputeAutoscaler(this, "foobar_4", {
        ...
        target: cdktf.Token.asString(
          googleComputeInstanceGroupManagerFoobar.id
        ),
        zone: "us-central1-f",
      });
    /*This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.*/
...
* `mode` -
  ...
  Default value is `on`.
  Possible values are: `off`, `onlyUp`, `on`.
...
* `type` -
  ...
  Possible values are: `gauge`, `deltaPerSecond`, `deltaPerMinute`.
