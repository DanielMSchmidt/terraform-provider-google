...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleVertexAiFeaturestoreFeaturestore =
      new google.VertexAiFeaturestore(this, "featurestore", {
        labels: [
          {
            foo: "bar",
          },
    ...
    const googleVertexAiFeaturestoreEntitytypeEntity =
      new google.VertexAiFeaturestoreEntitytype(this, "entity", {
    ...
    new google.VertexAiFeaturestoreEntitytypeFeature(this, "feature", {
