...
* `kind` -
  ...
  * KIND_REGEXP: Regexp entity types allow to specify regular expressions in entries values.
  Possible values are: `kindMap`, `kindList`, `kindRegexp`.
...
* `autoExpansionMode` -
  ...
  * AUTO_EXPANSION_MODE_DEFAULT: Allows an agent to recognize values that have not been explicitly listed in the entity.
  Possible values are: `autoExpansionModeDefault`, `autoExpansionModeUnspecified`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-fd10a3d7330d13902831b1ae5ab2c879689034b5e88fd70772f8fd4004d5a397 -->