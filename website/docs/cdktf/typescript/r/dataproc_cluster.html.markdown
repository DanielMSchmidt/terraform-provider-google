    ...
    new google.dataprocCluster.DataprocCluster(this, "accelerated_cluster", {
      clusterConfig: {
        ...
        masterConfig: {
          accelerators: [
            {
              acceleratorCount: cdktf.Token.asNumber("1"),
...
* `optionalComponents` - (Optional) The set of optional components to activate on the cluster. See [Available Optional Components](https://cloud.google.com/dataproc/docs/concepts/components/overview#available_optional_components).
