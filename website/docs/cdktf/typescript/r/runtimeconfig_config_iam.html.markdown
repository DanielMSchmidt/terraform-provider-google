...
* `googleRuntimeconfigConfigIamPolicy`: Retrieves the IAM policy for the config
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-4f7aa5a004886727af6816de23976771ca24c4c83c4a63a71be7e4fb169628f1 -->