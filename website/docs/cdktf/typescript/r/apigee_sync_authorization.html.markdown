...
* `identities` -
  ...
  The `serviceAccountName` is formatted like an email address. For example: my-synchronizer-manager-serviceAccount@my_project_id.iam.gserviceaccount.com
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-57b04932098d72f285da160ce83b9faf08323ac956376f8326e4b8923a011c5d -->