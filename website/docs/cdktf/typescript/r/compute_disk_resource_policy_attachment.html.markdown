...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleComputeDiskSsd = new google.computeDisk.ComputeDisk(
      this,
      "ssd",
      {
    ...
    new google.computeDiskResourcePolicyAttachment.ComputeDiskResourcePolicyAttachment(
      ...
      "attachment",
      {
        disk: cdktf.Token.asString(googleComputeDiskSsd.name),
        name: cdktf.Token.asString(googleComputeResourcePolicyPolicy.name),
        zone: "us-central1-a",
      }
    );
  }
