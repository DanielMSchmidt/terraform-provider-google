  ...
  constructor(scope: constructs.Construct, name: string) {
    ...
    const googleComputeGlobalAddressPrivateIpAlloc =
      new google.computeGlobalAddress.ComputeGlobalAddress(
        ...
        "private_ip_alloc",
        {
          ...
          network: cdktf.Token.asString(googleComputeNetworkPeeringNetwork.id),
          prefixLength: 16,
          purpose: "VPC_PEERING",
        }
      );
      ...
      new google.serviceNetworkingConnection.ServiceNetworkingConnection(
        ...
        "default",
        {
          ...
          reservedPeeringRanges: [
            cdktf.Token.asString(googleComputeGlobalAddressPrivateIpAlloc.name),
          ],
    ...
    new google.computeNetworkPeeringRoutesConfig.ComputeNetworkPeeringRoutesConfig(
      ...
      "peering_routes",
      {
        ...
        network: cdktf.Token.asString(googleComputeNetworkPeeringNetwork.name),
        peering: cdktf.Token.asString(
          googleServiceNetworkingConnectionDefault.peering
        ),
      }
    );
  }
