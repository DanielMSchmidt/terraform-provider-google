...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.billing_account_iam_policy.BillingAccountIamPolicy(self, "editor",
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.billing_account_iam_binding.BillingAccountIamBinding(self, "editor",
            billing_account_id="00AA00-000AAA-00AA0A",
            members=["user:jane@example.com"],
            role="roles/billing.viewer"
        )
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google.billing_account_iam_member.BillingAccountIamMember(self, "editor",
            billing_account_id="00AA00-000AAA-00AA0A",
