...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.identity_platform_tenant_oauth_idp_config.IdentityPlatformTenantOauthIdpConfig(self, "tenant_oauth_idp_config",
            client_id="client-id",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-8a4ab80104799b8591e5870238cdcd8f178b58425db020f59fb169dcd6046b48 -->