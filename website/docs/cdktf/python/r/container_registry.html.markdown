...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.container_registry.ContainerRegistry(self, "registry",
            location="EU",
            project="my-project"
        )
```
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_container_registry_registry =
        google.container_registry.ContainerRegistry(self, "registry",
            location="EU",
            project="my-project"
        )
        google.storage_bucket_iam_member.StorageBucketIamMember(self, "viewer",
            bucket=cdktf.Token.as_string(google_container_registry_registry.id),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-c8cc0d9e19b5e7544980ef43cb191b49b564cf441bd064592d1686562560de01 -->