...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google.cloud_run_service.CloudRunService(self, "default",
            ...
            traffic=[CloudRunServiceTraffic(
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_sql_database_instance_instance =
        google.sql_database_instance.SqlDatabaseInstance(self, "instance",
            database_version="MYSQL_5_7",
            deletion_protection=cdktf.Token.as_boolean("true"),
            name="cloudrun-sql",
            region="us-east1",
            ...
            template=CloudRunServiceTemplate(
                metadata=CloudRunServiceTemplateMetadata(
                    annotations={
                        ...
                        "run.googleapis.com/cloudsql-instances": cdktf.Token.as_string(google_sql_database_instance_instance.connection_name)
                    }
                ),
                spec=CloudRunServiceTemplateSpec(
                    containers=[CloudRunServiceTemplateSpecContainers(
...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        super().__init__(scope, name)
        google_cloud_run_service_default =
        google.cloud_run_service.CloudRunService(self, "default",
            location="us-central1",
            name="cloudrun-srv",
            template=CloudRunServiceTemplate(
        ...
        data_google_iam_policy_noauth =
        google.data_google_iam_policy.DataGoogleIamPolicy(self, "noauth",
        ...
        google_cloud_run_service_iam_policy_noauth =
        google.cloud_run_service_iam_policy.CloudRunServiceIamPolicy(self, "noauth_2",
            location=cdktf.Token.as_string(google_cloud_run_service_default.location),
            policy_data=cdktf.Token.as_string(data_google_iam_policy_noauth.policy_data),
            project=cdktf.Token.as_string(google_cloud_run_service_default.project),
            service=cdktf.Token.as_string(google_cloud_run_service_default.name)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_cloud_run_service_iam_policy_noauth.override_logical_id("noauth")
```
