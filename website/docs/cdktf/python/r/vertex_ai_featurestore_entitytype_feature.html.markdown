...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_vertex_ai_featurestore_featurestore =
        google.VertexAiFeaturestore(self, "featurestore",
            labels=[{
                "foo": "bar"
            }
            ],
        ...
        google_vertex_ai_featurestore_entitytype_entity =
        google.VertexAiFeaturestoreEntitytype(self, "entity",
            featurestore=google_vertex_ai_featurestore_featurestore.id,
            labels=[{
                "foo": "bar"
            }
            ],
        ...
        google.VertexAiFeaturestoreEntitytypeFeature(self, "feature",
            entitytype=google_vertex_ai_featurestore_entitytype_entity.id,
            labels=[{
                "foo": "bar"
            }
            ],
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-bfd40c7afe76bd4c55ae1d1447dd8483a073be503377a7452f4be6c8be073429 -->