...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_network_foobar = google.compute_network.ComputeNetwork(self, "foobar",
            auto_create_subnetworks=False,
            name="network-1"
        )
        google_compute_router_foobar = google.compute_router.ComputeRouter(self, "foobar_1",
            bgp=ComputeRouterBgp(
                asn=16550
            ),
            name="router-1",
            network=cdktf.Token.as_string(google_compute_network_foobar.name)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        google_compute_router_foobar.override_logical_id("foobar")
        google.compute_interconnect_attachment.ComputeInterconnectAttachment(self, "on_prem",
            edge_availability_domain="AVAILABILITY_DOMAIN_1",
            mtu=cdktf.Token.as_string(1500),
            name="on-prem-attachment",
            router=cdktf.Token.as_string(google_compute_router_foobar.id),
            type="PARTNER"
        )
```
<div class = "oics-button" style="float: right; margin: 0 0 -15px">
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-13463e6f48d6b5d4e13398a8c4c56b6b1a7578c97eb6eb544f1402518dfb7834 -->