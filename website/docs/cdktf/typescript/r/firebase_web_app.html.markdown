...
* `deletionPolicy` - (Optional) Set to `abandon` to allow the WebApp to be untracked from terraform state
...
* `id` - an identifier for the resource with format `projects/{{project}}/webApps/{{appId}}`
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-322039e0995c25d3307e28f57b9cdeb4e10f7f11db9dfa1c0715e311332aced6 -->