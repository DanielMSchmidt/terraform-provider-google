...
* `accessMode` -
  ...
  Possible values are: `readOnly`, `readWrite`.
...
* `squashMode` -
  ...
  Possible values are: `noRootSquash`, `rootSquash`.
...
* `modes` -
  ...
  Each value may be one of: `addressModeUnspecified`, `modeIpv4`, `modeIpv6`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-fc40cefe384d446251cd7a74ee08ba1cc1d29fb0ce5df28ba552fb4d7bcf0b71 -->