...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        google_compute_address_vpn_static_ip =
        google.compute_address.ComputeAddress(self, "vpn_static_ip",
            name="vpn-static-ip"
        )
        google_compute_network_network1 =
        google.compute_network.ComputeNetwork(self, "network1",
            name="network-1"
        )
        google_compute_vpn_gateway_target_gateway =
        google.compute_vpn_gateway.ComputeVpnGateway(self, "target_gateway",
            name="vpn-1",
            network=cdktf.Token.as_string(google_compute_network_network1.id)
        )
        google_compute_forwarding_rule_fr_esp =
        google.compute_forwarding_rule.ComputeForwardingRule(self, "fr_esp",
            ip_address=cdktf.Token.as_string(google_compute_address_vpn_static_ip.address),
            ip_protocol="ESP",
            name="fr-esp",
            target=cdktf.Token.as_string(google_compute_vpn_gateway_target_gateway.id)
        )
        google_compute_forwarding_rule_fr_udp4500 =
        google.compute_forwarding_rule.ComputeForwardingRule(self, "fr_udp4500",
            ip_address=cdktf.Token.as_string(google_compute_address_vpn_static_ip.address),
            ip_protocol="UDP",
            name="fr-udp4500",
            port_range="4500",
        ...
        google_compute_forwarding_rule_fr_udp500 =
        google.compute_forwarding_rule.ComputeForwardingRule(self, "fr_udp500",
            ip_address=cdktf.Token.as_string(google_compute_address_vpn_static_ip.address),
            ip_protocol="UDP",
            name="fr-udp500",
            port_range="500",
        ...
        google.compute_vpn_tunnel.ComputeVpnTunnel(self, "tunnel1",
            depends_on=[google_compute_forwarding_rule_fr_esp, google_compute_forwarding_rule_fr_udp500, google_compute_forwarding_rule_fr_udp4500
            ],
            name="tunnel-1",
            peer_ip="15.0.0.120",
            shared_secret="a secret message",
            target_vpn_gateway=cdktf.Token.as_string(google_compute_vpn_gateway_target_gateway.id)
        )
        google.compute_route.ComputeRoute(self, "route1",
            dest_range="15.0.0.0/24",
            name="route1",
            network=cdktf.Token.as_string(google_compute_network_network1.name),
            next_hop_vpn_tunnel=cdktf.Token.as_string(google_compute_vpn_tunnel_tunnel1.id),
            priority=1000
        )
```
<div class = "oics-button" style="float: right; margin: 0 0 -15px">
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-2a4de75dfd5118d42f9b9686d26dbaf0d41e28710ea1c3b225901bd05a855b69 -->