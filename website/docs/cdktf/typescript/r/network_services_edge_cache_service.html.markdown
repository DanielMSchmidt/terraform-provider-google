...
* `cacheMode` -
  ...
  Possible values are: `cacheAllStatic`, `useOriginHeaders`, `forceCacheAll`, `bypassCache`.
...
* `signedRequestMode` -
  ...
  Possible values are: `disabled`, `requireSignatures`, `requireTokens`.
...
* `allowedSignatureAlgorithms` -
  ...
  Each value may be one of: `ed25519`, `hmacSha256`, `hmacSha1`.
...
* `actions` -
  ...
  Each value may be one of: `generateCookie`, `generateTokenHlsCookieless`, `propagateTokenHlsCookieless`.
...
* `redirectResponseCode` -
  ...
  Possible values are: `movedPermanentlyDefault`, `found`, `seeOther`, `temporaryRedirect`, `permanentRedirect`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-b8af07ba644d91da13365c0820c9da2ddc368d9d0d469e29c17bc13408a4b315 -->