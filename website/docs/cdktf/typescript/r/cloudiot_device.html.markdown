...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    new google.cloudiotDevice.CloudiotDevice(this, "test-device", {
      ...
      registry: cdktf.Token.asString(googleCloudiotRegistryRegistry.id),
    });
  }
}
...
* `format` -
  ...
  Possible values are: `rsaPem`, `rsaX509Pem`, `es256Pem`, `es256X509Pem`.
...
* `gatewayType` -
  ...
  Possible values are: `gateway`, `nonGateway`.

* `gatewayAuthMethod` -
  (Optional)
  Indicates whether the device is a gateway.
  Possible values are: `associationOnly`, `deviceAuthTokenOnly`, `associationAndDeviceAuthToken`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-b61897dd888cbc8fbfbdbeb0afecd119b62cffeb1f681a97c88731222f9f7916 -->